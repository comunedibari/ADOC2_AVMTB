			...
			if( !fileBean.getIsPdf() ){
				...
				if( !isFileFirmato ) {
					...
					if( isPdfConversionEnabled ){
						...
						logger.info("La Conversione in pdf non e' abilitata o non puo' essere effettuata, verra'� firmato il file originale");
					}
				} else {
				...
				fileBean.setIsPdf(true);
				logger.info("Il file e' pdf, verra'� effettuata la firma sul file pdf");
				if( isFileFirmato ) {
					logger.info("Il file da firmare e' gia'� firmato");
					fileBean.setIsFirmato(true);
				} else {
					logger.info("Il file da firmare non e' gia' firmato");
					fileBean.setIsFirmato( false );
				}
			}
...
//				}
				...
				fileBean.setIsPdf(true);
				logger.info("Il file e' pdf, verra'� firmato il file originale");
				if( isFileFirmato ){
					logger.info("Il file e' gia'� firmato");
					fileBean.setIsFirmato(true);
				} else {
					logger.info("Il file non e' gia'� firmato");
					fileBean.setIsFirmato( false );
				}
			}
		}
