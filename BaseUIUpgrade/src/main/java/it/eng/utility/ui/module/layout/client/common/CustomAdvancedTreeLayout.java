				...
				getListaDefPrefs(new ServiceCallback<Record>() {
					...
					public void execute(Record object) {
						...
						if (object.getAttribute("layoutFiltro") != null) {
							...
							filter.setCriteria(new AdvancedCriteria(JSON.decode(object.getAttribute("layoutFiltro"))));
						} else if (object.getAttribute("layoutFiltroDefault") != null) {
							ricercaPreferitaSelectItem.setValue((String) null);
							layoutFiltroSelectItem.setValue((String) null);
							filter.setCriteria(new AdvancedCriteria(JSON.decode(object.getAttribute("layoutFiltroDefault"))));
						} else {
							ricercaPreferitaSelectItem.setValue((String) null);
							layoutFiltroSelectItem.setValue((String) null);
...
//						setCriteriaAndFirstSearch(initialCriteria, object.getAttributeAsBoolean("autosearch"));
						setCriteriaAndFirstSearch(checkRetrocompatibilitaFiltri(new AdvancedCriteria(JSON.decode(object.getAttribute("ricercaPreferita")))), object.getAttributeAsBoolean("autosearch"));
...
//						setCriteriaAndFirstSearch(initialCriteria, object.getAttributeAsBoolean("autosearch"));
						setCriteriaAndFirstSearch(checkRetrocompatibilitaFiltri(new AdvancedCriteria(JSON.decode(object.getAttribute("ricercaPreferitaDefault")))), object.getAttributeAsBoolean("autosearch"));
					} else if (object.getAttribute("layoutFiltroDefault") != null) {
						ricercaPreferitaSelectItem.setValue((String) null);
						layoutFiltroSelectItem.setValue((String) null);
...
//					setCriteriaAndFirstSearch(initialCriteria, autoSearch);
					setCriteriaAndFirstSearch(new AdvancedCriteria(JSON.decode(data[0].getAttribute("value"))), autoSearch);
				} else {
	...
	public void doSearch(AdvancedCriteria criteria) {
		// ogni volta che effettuo una ricerca mi salvo il livello corretnte in cache (filtri e modalità di ricerca)
