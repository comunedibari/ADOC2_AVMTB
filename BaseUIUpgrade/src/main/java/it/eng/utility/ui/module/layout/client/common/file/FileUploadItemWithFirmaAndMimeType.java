...
public class FileUploadItemWithFirmaAndMimeType extends PrettyFileUploadItem {
	...
	public FileUploadItemWithFirmaAndMimeType(
			UploadItemCallBackHandler pCallBackHandler, ManageInfoCallbackHandler pManageInfoCallbackHandler) {
	...
	public FileUploadItemWithFirmaAndMimeType(
			UploadItemCallBackHandler pCallBackHandler, ManageInfoCallbackHandler pManageInfoCallbackHandler, CssAndDimensionFileInput pCssAndDimensionFileInput) {
