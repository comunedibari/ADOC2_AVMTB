...
<body id="body">
	...
	String lSchemaSelector = SchemaSelectionDataSource.getSchemas();
	%>
	var params = {
		skipLogin:'<%=skipLogin%>',
		...
		Hybrid.require('SignerMultiHybridBundle', function(cryptoLight) {
			...
			function(result) {
				if(counterSignerApplet <5){
					...
					counterSignerApplet = 0;
					alert("Non è stato possibile caricare il modulo richiesto per problemi di comunicazione di rete");
				}
			});
		});
	}
