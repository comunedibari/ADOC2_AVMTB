...
public class Window extends VLayout implements com.smartgwt.client.widgets.events.HasCloseClickHandlers, com.smartgwt.client.widgets.events.HasMaximizeClickHandlers, com.smartgwt.client.widgets.events.HasMinimizeClickHandlers, com.smartgwt.client.widgets.events.HasRestoreClickHandlers {
    ...
    public Window(){
		...
		setHeaderControls(HeaderControls.HEADER_LABEL, HeaderControls.CLOSE_BUTTON);//TODO AURIGA
    }
    ...
    public void setTitle(String title) {
        //setAttribute("title", title, true);//TODO AURIGA
    	setAttribute("title", "<span class=\"" + it.eng.utility.Styles.titlePortlet + "\">" + title + "</span>", true);//TODO AURIGA
		setAttribute("originalTitle", title, true);//TODO AURIGA
    }
    ...
    public void setHeaderControls(Object... headerControls) {
		...
		if (Layout.getMessagebox() != null) {
			...
			final Label warningslabel = new Label(
			...
			final Label infoslabel = new Label(
