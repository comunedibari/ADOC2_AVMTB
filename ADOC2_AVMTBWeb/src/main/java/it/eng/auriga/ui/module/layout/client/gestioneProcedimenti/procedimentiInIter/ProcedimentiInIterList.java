...
public class ProcedimentiInIterList extends CustomList{
	...
	public ProcedimentiInIterList(String nomeEntita) {
		...
		dataAvvioProcedimentoField              = new ListGridField("dataAvvioProcedimento",            I18NUtil.getMessages().procedimenti_in_iter_list_dataAvvioProcedimentoField());  dataAvvioProcedimentoField.setType(ListGridFieldType.DATE); dataAvvioProcedimentoField.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATE);
		...
		scadenzaTermineProcedimentoField        = new ListGridField("scadenzaTermineProcedimento",      I18NUtil.getMessages().procedimenti_in_iter_list_scadenzaTermineProcedimentoField()); scadenzaTermineProcedimentoField.setType(ListGridFieldType.DATE);scadenzaTermineProcedimentoField.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATE);
...
//		if (fieldName.equals("iconaMessaggioUltimoTask")) {	
//			HLayout recordCanvas = new HLayout(1);
//			recordCanvas.setHeight(22);   
//			recordCanvas.setWidth(25);
//			recordCanvas.setAlign(Alignment.CENTER);
//			recordCanvas.setLayoutLeftMargin(3);   
//			recordCanvas.setLayoutRightMargin(3);
//			recordCanvas.setMembersMargin(7);
//			
//			ImgButton iconaMessaggioUltimoTaskButton = new ImgButton();   
//			iconaMessaggioUltimoTaskButton.setShowDown(false);   
//			iconaMessaggioUltimoTaskButton.setShowRollOver(false); 
//			
//			String messaggioUltimoTask = (String) record.getAttribute("messaggioUltimoTaskProcedimento");
//			
//			if(messaggioUltimoTask != null && !"".equals(messaggioUltimoTask)) {
//				iconaMessaggioUltimoTaskButton.setSrc("buttons/doc.png");
//			}
//			else{
//				iconaMessaggioUltimoTaskButton.setSrc("blank.png");
//			}
//			
//			iconaMessaggioUltimoTaskButton.setPrompt("Apre il messaggio ultimo task.");
//			
//			iconaMessaggioUltimoTaskButton.setSize(16);  
//			iconaMessaggioUltimoTaskButton.addClickHandler(new ClickHandler() {   
//				public void onClick(ClickEvent event) {   
//					messaggioUltimoTaskProcedimentoButtonClick(record);
//					
//				}  
//			}); 
//			recordCanvas.setMembers(iconaMessaggioUltimoTaskButton);
...
//		}
	...
	protected void folderDetailButtonClick(Record record) {
//		String idUdFolder = record.getAttribute("idUdFolder");
//		final String estremiProcedimento  = record.getAttribute("estremiProcedimento");
//		if(idUdFolder!=null && !idUdFolder.equalsIgnoreCase("")){
//			
...
//						record.setAttribute("estremiProcedimento", estremiProcedimento);						
//						DettaglioFolderProcedimentoPopup dettaglioFolderProcedimentoPopup = new DettaglioFolderProcedimentoPopup(record);
//						dettaglioFolderProcedimentoPopup.popolaForm(record);
//						dettaglioFolderProcedimentoPopup.viewMode();
//						dettaglioFolderProcedimentoPopup.show();
//					} 				
//				}
//			});
//		}
		AurigaLayout.apriDettaglioPratica(record.getAttribute("idProcedimento"), record.getAttribute("estremiProcedimento"), new DSCallback() {			
			@Override
			public void execute(DSResponse response, Object rawData, DSRequest request) {
				
				if(getLayout() != null) getLayout().doSearch();  
			}
		});		
	}
