	...
	public void clickAttestatoConformita(Record record) {
		...
		SC.ask("Vuoi firmare digitalmente l’attestato ?", new BooleanCallback() {
			...
			public void execute(Boolean value) {
				...
				if (value) {
					creaAttestato(fileAllegato, uri, true);
				} else
					creaAttestato(fileAllegato, uri, false);

			}
		});
	}

	protected void creaAttestato(final InfoFileRecord infoFileAllegato, String uriFileAllegato, final boolean attestatoFirmato) {
