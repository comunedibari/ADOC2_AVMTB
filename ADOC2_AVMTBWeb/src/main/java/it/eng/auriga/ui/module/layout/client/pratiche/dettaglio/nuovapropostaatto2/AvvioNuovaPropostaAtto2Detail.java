...
public abstract class AvvioNuovaPropostaAtto2Detail extends NuovaPropostaAtto2Detail implements TaskFlussoInterface {
	...
	public Record getRecordToSave() {
		...
		lRecordToSave.setAttribute("siglaRegProvvisoria", recordAvvio.getAttribute("siglaProposta"));
			...
			lNuovaPropostaAtto2DataSource.addData(lRecordToSave, new DSCallback() {
				...
				public void execute(DSResponse response, Object rawData, DSRequest request) {
					if (response.getStatus() == DSResponse.STATUS_SUCCESS) {
						...
						avvioNuovaPropostaAtto2(idUd, idFolder, idDocPrimario, ufficioProponente, oggetto);						
					}
				}
			});
		} else {
...
//		}
	...
	public abstract void avvioNuovaPropostaAtto2(String idUd, String idFolder, String idDocPrimario, String uoProtocollante, String oggetto);
