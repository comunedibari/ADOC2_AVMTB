...
public class DettaglioRegProtAssociatoWindow extends ModalWindow {
	...
	public DettaglioRegProtAssociatoWindow(Record record, String taskName, String title) {
		...
		//switch per caricare il dettaglio generico o il dettaglio relativo alla risposta
		if(record.getAttribute("rispondi") != null && "true".equals(record.getAttribute("rispondi"))) {
			loadGetDatiUDRisposta(record,taskName);
		}else {
	...
	private void loadGetDatiUDRisposta(final Record record,String taskName){
