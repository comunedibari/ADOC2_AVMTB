...
public abstract class AltriDatiRicezionePopup extends Window {
	...
	protected NumericItem nroRaccomandataItem;
	...
	public AltriDatiRicezionePopup(boolean canEdit, String idRegistrazione){
		...
		nroRaccomandataItem = new NumericItem("nroRaccomandata", I18NUtil.getMessages().protocollazione_detail_nroRaccomandataItem_title());
		nroRaccomandataItem.setLength(7);
