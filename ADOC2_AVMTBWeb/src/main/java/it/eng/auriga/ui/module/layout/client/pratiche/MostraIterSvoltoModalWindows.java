...
public class MostraIterSvoltoModalWindows extends ModalWindow {
	...
	public MostraIterSvoltoModalWindows(String idPrecessIn, String estremi) {
		...
		String title = I18NUtil.getMessages().atti_in_lavorazione_iter_svolto_title() + " " + ((estremi != null) ? (estremi) : (""));
		setTitle(title);
		...
		// tipoEventoItem = new TextItem("tipoEvento", "Tipo evento");
		// tipoEventoItem.setWidth("*");

		descrizioneEventoItem = new TextItem("descrizioneEvento", I18NUtil.getMessages().atti_in_lavorazione_iter_svolto_filtro_nome());
		descrizioneEventoItem.setWidth("100%");
		descrizioneEventoItem.setStartRow(true);
		descrizioneEventoItem.setTabIndex(1);

		descrizioneUtenteItem = new TextItem("descrizioneUtente", I18NUtil.getMessages().atti_in_lavorazione_iter_svolto_filtro_svolta_da());
		descrizioneUtenteItem.setWidth("100%");
		descrizioneUtenteItem.setStartRow(true);
		descrizioneUtenteItem.setTabIndex(2);

		// descrizioneEsitoItem = new TextItem("descrizioneEsito", "Descrizione esito");
		// descrizioneEsitoItem.setWidth("100%");

		dettagliEventoItem = new TextItem("dettagliEvento", I18NUtil.getMessages().atti_in_lavorazione_iter_svolto_filtro_messaggio());
		dettagliEventoItem.setWidth("100%");
		dettagliEventoItem.setStartRow(true);
		dettagliEventoItem.setTabIndex(3);

		cercaButtonItem = new ButtonItem(I18NUtil.getMessages().atti_in_lavorazione_iter_svolto_bottone_cerca());
		...
		// _form.setFields(new FormItem[]{tipoEventoItem, descrizioneEventoItem, descrizioneUtenteItem, descrizioneEsitoItem, dettagliEventoItem,
		// cercaButtonItem});
		...
		DetailSection detailSectionRicerca = new DetailSection(I18NUtil.getMessages().atti_in_lavorazione_iter_svolto_form_title(), false, true, false, _form);
	...
	private void refreshTree() {
		// String codTipoEventoIn = tipoEventoItem.getValueAsString();
		...
		// String desEsitoIn = descrizioneEsitoItem.getValueAsString();
