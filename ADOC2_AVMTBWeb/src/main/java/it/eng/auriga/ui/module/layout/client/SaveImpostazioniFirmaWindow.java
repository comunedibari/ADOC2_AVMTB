...
public class SaveImpostazioniFirmaWindow extends ModalWindow {
	...
	private static String tipofirmaClient = "C";
	private static String tipofirmaRemota =  "R";
	private static String tipofirmaRemotaAutomatica = "A";
	...
	public SaveImpostazioniFirmaWindow() {
		...
		tipoFirmaMap.put(tipofirmaClient, I18NUtil.getMessages().configUtenteMenuImpostazioniFirma_client_value());
		tipoFirmaMap.put(tipofirmaRemota, I18NUtil.getMessages().configUtenteMenuImpostazioniFirma_remota_value());	
		tipoFirmaMap.put(tipofirmaRemotaAutomatica, I18NUtil.getMessages().configUtenteMenuImpostazioniFirma_remotaAutomatica_value());
		...
		userIdItem.setShowIfCondition(new FormItemIfFunction() {
			...
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				...
				return tipofirmaRemota.equalsIgnoreCase(tipoFirmaSelectItem.getValueAsString()) ||
				   tipofirmaRemotaAutomatica.equalsIgnoreCase(tipoFirmaSelectItem.getValueAsString());
			}
		});
		...
		passwordItem.setShowIfCondition(new FormItemIfFunction() {
			...
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				...
				return tipofirmaRemotaAutomatica.equals((String)tipoFirmaSelectItem.getValue());
			}
		});
		...
		confermaPasswordItem.setShowIfCondition(new FormItemIfFunction() {
			...
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				...
				return tipofirmaRemotaAutomatica.equalsIgnoreCase(tipoFirmaSelectItem.getValueAsString()) &&
		...
		CustomValidator validatorConfermaPwd = new CustomValidator() {
			...
			protected boolean condition(Object value) {
				...
				if(tipofirmaRemotaAutomatica.equals((String)tipoFirmaSelectItem.getValue())) {
		...
		mDynamicForm.setItems(tipoFirmaSelectItem,userIdItem,firmaInDelegaItem,passwordItem,cambiaPasswordButton,confermaPasswordItem);
