...
public class CaricamentoRubricaClientiWindow extends CustomDetail {
	...
	public void populateFormFile() {
		...
		final TextItem nomeFileItem = new TextItem("nomeFile", I18NUtil.getMessages().caricamentoRubricaClientiWindow_nomeFile());
		...
		formFile.setItems(nomeFileItem, uriItem, infoFileItem, uploadFileItem);
	}
	...
	public void init() {
		...
		tipoCaricamentoSelect.setColSpan(1);
		...
		form.setItems(tipoCaricamentoSelect);
	...
	protected ToolStrip buildSaveButton() {

		final ToolStrip detailToolStrip = new ToolStrip();
