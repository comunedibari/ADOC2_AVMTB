...
public abstract class LookupListaFunzionalitaPopup extends ModalWindow{
	...
	LookupListaFunzionalitaPopup _window;

	public LookupListaFunzionalitaPopup(String idProfilo, String nomeProfilo) {
		
		super("lista_funzionalita",true);
		
		_window = this;
		setTitle("Aggiungi abilitazioni a funzioni");
		
		final GWTRestDataSource lGWTRestDataSource = new GWTRestDataSource("AurigaListaFunzionalitaDataSource");		
		lGWTRestDataSource.addParam("flgStatoAbil", "0");
