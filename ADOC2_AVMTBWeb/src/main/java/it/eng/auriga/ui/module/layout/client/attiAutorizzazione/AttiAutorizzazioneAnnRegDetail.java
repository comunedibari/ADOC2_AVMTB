...
public class AttiAutorizzazioneAnnRegDetail extends CustomDetail {
	...
	public AttiAutorizzazioneAnnRegDetail(String nomeEntita) {
		...
		nroBozzaItem = new NumericItem("nroBozza", "Bozza N°");
		nroBozzaItem.setStartRow(true);
				
		tsRegBozzaItem = new DateItem("tsRegBozza", "creata il");
		
		desUteBozzaItem = new TextItem("desUteBozza", "da");
		
		nroAttoItem = new NumericItem("nroAtto", "Atto N°");
		nroAttoItem.setStartRow(true);
		
		tsRegAttoItem = new DateItem("tsRegAtto", "chiuso il");		
		
		desUteAttoItem = new TextItem("desUteAtto", "da");
		...
		regDaAnnullareSection = new DetailSection("Registrazioni da annullare", true, true, true, regDaAnnullareForm);
