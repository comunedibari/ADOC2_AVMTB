...
public class NuovoAttiRichiestiItem extends ReplicableItem{
	...
	protected ImgButton[] createAddButtons() {
		...
		addButtons[1].setPrompt("Aggiunta con scelta multipla da archivio");
	...
	public class AttiRichiestiMultiLookupArchivio extends LookupArchivioPopup {
		...
		public AttiRichiestiMultiLookupArchivio(Record record) {
			super(record, null, false);
		}
		
		public AttiRichiestiMultiLookupArchivio(Record record, String idRootNode) {
