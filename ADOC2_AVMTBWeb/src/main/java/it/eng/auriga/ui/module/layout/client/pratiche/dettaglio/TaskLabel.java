...
public class TaskLabel extends Label {
	...
	public TaskLabel(String titolo, String dettagli, String motiviNonEseg, String icon, final String flgFatta, final String flgEsito, String flgDisponibile, DettaglioPraticaLayout pDettaglioPraticaLayout) {
		
		this.dettaglioPraticaLayout = pDettaglioPraticaLayout;
		
		setHeight(30);
		setIcon(dettaglioPraticaLayout.getIconaVoceMenu(flgFatta, flgEsito));
		setIconSize(24);	
		...
		addHoverHandler(new HoverHandler() {
			...
			public void onHover(HoverEvent event) {
				...
				setPrompt(dettaglioPraticaLayout.getPromptIconaVoceMenu(flgFatta, flgEsito));
			}
		});
