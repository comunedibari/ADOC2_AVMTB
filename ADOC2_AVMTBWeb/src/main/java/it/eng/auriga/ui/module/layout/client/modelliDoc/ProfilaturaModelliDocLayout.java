...
//					}
					...
					if(flgComplex && (nomeVariabile.startsWith(recordAssociazioniAttributiCustom.getAttribute("nomeVariabileModello")) || (recordAssociazioniAttributiCustom.getAttribute("aliasVariabileModello") != null && nomeVariabile.startsWith(recordAssociazioniAttributiCustom.getAttribute("aliasVariabileModello"))))) {
						String nomeAttributoComplex = recordAssociazioniAttributiCustom.getAttribute("nomeAttributoCustom");
...
//									}
									...
									final int pos = j;
									AssociazioniSottoAttributiComplexPopup lAssociazioniSottoAttributiComplexPopup = new AssociazioniSottoAttributiComplexPopup("Associa con sotto-attributo di " + nomeAttributoComplex, nomeTabella, idEntitaAssociata, recordAssociazioneSottoAttributiComplex) {
