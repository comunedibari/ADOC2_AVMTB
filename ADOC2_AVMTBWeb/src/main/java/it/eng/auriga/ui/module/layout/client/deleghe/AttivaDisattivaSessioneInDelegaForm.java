...
public class AttivaDisattivaSessioneInDelegaForm extends DynamicForm {
	...
	private SelectItem lSelectDelega;
	...
	public AttivaDisattivaSessioneInDelegaForm(AttivaDisattivaSessioneInDelegaWindow pSchemaSelectionWindow) {
		...
		setCellPadding(5);
		lSelectDelega = new SelectItem("delega", "A nome di");
		lSelectDelega.setRequired(true);
		lSelectDelega.setWidth(200);
		lSelectDelega.setValueField("idUser");
		lSelectDelega.setDisplayField("descrizione");
		lSelectDelega.addChangedHandler(new ChangedHandler() {
		...
		lTextAreaItem
				.setTitle("&nbsp;&nbsp;&nbsp;<img src=\"images/warning.png\" style=\"vertical-align:bottom\"/>&nbsp;<font color=\"red\"><b>Attenzione<b/></font>");
		lTextAreaItem.setVisible(false);
		lTextAreaItem.setCanEdit(false);

		// CheckboxItem lCheckboxItem = new CheckboxItem("mantieniPreference", "Mantieni le mie preferenze");
		// lCheckboxItem.setValue(false);
		// lCheckboxItem.setShowTitle(true);

		GWTRestDataSource lGwtRestDataSource = new GWTRestDataSource("AurigaLoadDelegheDataSource");
		lSelectDelega.setOptionDataSource(lGwtRestDataSource);

		setDataSource(new GWTRestDataSource("AurigaDelegaDataSource"));
		setFields(lSelectDelega, /* lCheckboxItem, */lTextAreaItem);
	...
	public String getUtenteSelezionato() {
		return form.getValueAsString("delega");
	}
