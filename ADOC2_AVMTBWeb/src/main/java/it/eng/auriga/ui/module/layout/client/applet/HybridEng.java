...
public abstract class HybridEng extends HTMLFlow {
	...
	public HybridEng(String appletName, String jnplName, Map<String, String> parameters, int width, int height, boolean isWidthPerc, boolean isHeightPerc,
	...
	public void realCloseClick(final HybridWindow pWindow) {
		...
		if (uploadDone) {
			...
			GWTRestService<Object, Object> lGwtRestService = new GWTRestService<Object, Object>("AppletDatasource");
			loadWindow.show("Trasferimento file in corso");
