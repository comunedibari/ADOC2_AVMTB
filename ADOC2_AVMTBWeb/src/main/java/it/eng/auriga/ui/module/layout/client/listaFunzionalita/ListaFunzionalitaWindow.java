...
public class ListaFunzionalitaWindow extends ModalWindow{
	...
	public ListaFunzionalitaWindow(String title, final String idProfilo, final String nomeProfilo, final boolean funzioniAbilitate, final boolean canEditProfilo) {
		...
		lGWTRestDataSource.addParam("flgTpDestAbil", "PR");
		lGWTRestDataSource.addParam("idDestAbil", idProfilo);
		
		portletLayout = new ListaFunzionalitaLayout(lGWTRestDataSource, idProfilo, nomeProfilo) {
			@Override
...
//				
//				LookupListaFunzionalitaPopup lookupFunzionalitaPopup = new LookupListaFunzionalitaPopup(idProfilo, nomeProfilo) {
//
//					final HashMap<String, Record> mappaListaFunzioni = new HashMap<String, Record>();
//					
//					@Override
//					public void manageLookupBack(Record record) {
//												
//						mappaListaFunzioni.put(record.getAttribute("codice"), record);						
//					}
//
//					@Override
...
//						
//						mappaListaFunzioni.remove(record.getAttribute("codice"));											
//					}
//					
//					@Override
...
//							
//						
//						if(mappaListaFunzioni.keySet().size() > 0) {
//							
//							RecordList listaFunzioni = new RecordList(mappaListaFunzioni.values().toArray(new Record[mappaListaFunzioni.keySet().size()]));
//						
//							Record lRecord = new Record();
//							lRecord.setAttribute("idProfilo", idProfilo);
//							lRecord.setAttribute("listaFunzioni", listaFunzioni);
//							
//							lGWTRestDataSource.performCustomOperation("aggiungiAbilFunzioneProfilo", lRecord, new DSCallback() {
//								@Override
