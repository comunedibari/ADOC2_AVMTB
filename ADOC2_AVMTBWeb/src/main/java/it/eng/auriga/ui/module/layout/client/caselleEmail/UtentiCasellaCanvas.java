...
public class UtentiCasellaCanvas extends ReplicableCanvas{	
	...
	public void editRecord(Record record) {
		...
		if(record.getAttribute("idUser") != null && !"".equals(record.getAttributeAsString("idUser"))) {
			...
			valueMap.put(record.getAttribute("idUser"), record.getAttribute("cognomeNome") + " ** " + record.getAttribute("username"));			
			utenteItem.setValueMap(valueMap);							
		} 	
		GWTRestDataSource utenteDS = (GWTRestDataSource) utenteItem.getOptionDataSource();
		if(record.getAttribute("idUser") != null && !"".equals(record.getAttributeAsString("idUser"))) {			
			utenteDS.addParam("idUser", record.getAttributeAsString("idUser"));									
		} else {
			utenteDS.addParam("idUser", null);						
		}
