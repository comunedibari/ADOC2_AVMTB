...
public abstract class ArchiviaConludiLavorazionePopup extends Window {
	
	private ArchiviaConludiLavorazionePopup window;
	
	private DynamicForm form;
	protected SelectItem statoUdItem;
	
	public ArchiviaConludiLavorazionePopup(){
