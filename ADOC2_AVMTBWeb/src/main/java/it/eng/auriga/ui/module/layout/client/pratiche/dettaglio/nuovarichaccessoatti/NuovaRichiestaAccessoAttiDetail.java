...
//				}
		...
		visualizzaDettStdProtButton = new ImgButtonItem("visualizzaDettStdProtButton", "buttons/detail.png", "Visualizza dati protocollo");
...
//				idUdItem, rowidDocItem, tipoDocumentoItem, nomeTipoDocumentoItem, flgTipoDocConVieItem, codStatoRichAccessoAttiItem, idNodoDefaultRicercaAttiItem, 
...
//				listaRespIstruttoriaItem);
				
		estremiRichiestaForm.setItems(
				idUdItem, rowidDocItem, tipoDocumentoItem, nomeTipoDocumentoItem, flgTipoDocConVieItem, codStatoRichAccessoAttiItem, idNodoDefaultRicercaAttiItem, 
				nroProtocolloRichiestaItem, annoProtocolloRichiestaItem, dataProtocolloRichiestaItem, visualizzaDettStdProtButton, 
				lookupArchivioButton, operazioniEffettuateButton, listaRespIstruttoriaItem);
	...
	private void buildAttiRichiestiSection() {
		...
		attiRichiestiForm.setFields(attiRichiestiItem);
	...
	private void buildDocumentiIstruttoriaSection() {
		...
		listaDocumentiIstruttoriaItem = new AllegatiItem() {
			...
			@Override
			public Integer getWidthNomeFileOmissis() {
				return 250;
			}
...
////		incaricatoPrelievoUffRichiedenteForm.setPadding(11);
...
////		incaricatoPrelievoPerRichEsternoForm.setPadding(11);
...
//	}
	...
	private boolean manageErroreSingoloAzioneRichiestaAtti(Record object, boolean closeDetailAfterOperation) {
