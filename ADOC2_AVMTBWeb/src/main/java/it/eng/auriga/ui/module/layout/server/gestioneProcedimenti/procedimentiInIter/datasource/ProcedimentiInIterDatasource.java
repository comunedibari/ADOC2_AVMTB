...
public class ProcedimentiInIterDatasource extends AbstractFetchDataSource<ProcedimentiInIterBean> {
...
//			lProcedimentiInIterBean.setOggettoProcedimento(HtmlUtils.htmlEscape(lProcedimentiInIterBean.getOggettoProcedimento()));
		...
		return new PaginatorBean<ProcedimentiInIterBean>(lList);
	}
