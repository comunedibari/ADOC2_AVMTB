...
public class OsservazioneNotificaDetail extends CustomDetail {
	...
	private RichTextItem messageItem;
	...
	private void buildEstremiRichiestaSection() {
		...
		osservazioneNotificaForm.setTabID("HEADER");
		...
		messageItem = new RichTextItem();
		messageItem.setColSpan(7);
		messageItem.setWidth(900);
		messageItem.setHeight(200);
		messageItem.setStartRow(true);
		messageItem.setRequired(true);
		messageItem.setName("messaggioOsservazioneNotifica");
		messageItem.setShowTitle(true);
		messageItem.setTitle(I18NUtil.getMessages().osservazioniNotifiche_detail_messaggio_title());
		messageItem.setCellStyle(it.eng.utility.Styles.textItem);
		
		osservazioneNotificaForm.setItems(spacer, destinatariItem, prioritaItem, messageItem);
		
		lVLayoutMain.addMember(osservazioneNotificaForm);
