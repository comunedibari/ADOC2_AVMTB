...
public class CampoCaricaRubricaClientiCanvas extends ReplicableCanvas {
	...
	public void disegna() {
		...
		attributoSelectItem = new SelectItem("nomeCampo", "Attributo");
		...
		attributoSelectItem.setWidth(300);
		attributoSelectItem.setWrapTitle(false);
		attributoSelectItem.setAllowEmptyValue(true);
		...
		colonnaItem = new TextItem("colonnaRif", "Da colonna");
		...
		replicableCanvasForm.setFields(typeItem, attributoSelectItem, colonnaItem);
