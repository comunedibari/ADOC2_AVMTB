...
public class SceltaRepertorioPopup extends Window {
	...
	public SceltaRepertorioPopup(String repertorioDefault, final ServiceCallback<Record> callback) {
		...
		form = new SceltaRepertorioForm(repertorioDefault, instance, callback);
		form.setHeight100();
