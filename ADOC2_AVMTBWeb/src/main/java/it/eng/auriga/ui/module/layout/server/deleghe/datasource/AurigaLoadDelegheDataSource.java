...
public class AurigaLoadDelegheDataSource extends AbstractFetchDataSource<UtenteDelegabileBean> {
	...
	@Override
	public PaginatorBean<UtenteDelegabileBean> fetch(AdvancedCriteria criteria,
		...
		List<UtenteDelegabileBean> resultList = XmlListaUtility.recuperaLista(lStringXml, UtenteDelegabileBean.class);
		PaginatorBean<UtenteDelegabileBean> toReturn = new PaginatorBean<UtenteDelegabileBean>();
