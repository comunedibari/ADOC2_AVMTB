...
public class ProcedimentiPersonaliLayout extends CustomLayout {
	...
	public ProcedimentiPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola, Boolean showOnlyDetail) {
		super(nomeEntita, new GWTRestDataSource("ProcedimentiPersonaliDatasource"), new ProcedimentiPersonaliFilter(nomeEntita), new ProcedimentiPersonaliList(
	...
	protected MultiToolStripButton[] getMultiselectButtons() {
		// Bottone assegnazione massiva procedimenti
		...
		return new MultiToolStripButton[] { assegnaMultiButton };
