...
public class CaricamentoRubricaRowDetailsBean {
	...
	@TipoData(tipo = Tipo.DATA)
	private Date ultimaElaborazione;
	...
	/**
	 * @return the valoreNumero
	 */
	public String getValoreNumero() {
		return valoreNumero;
	}

	/**
	 * @param valoreNumero
	 *            the valoreNumero to set
	 */
	public void setValoreNumero(String valoreNumero) {
		this.valoreNumero = valoreNumero;
	}

	/**
	 * @return the valoreData
	 */
	...
	/**
	 * @param ultimaElaborazione
	 *            the ultimaElaborazione to set
	 */
	...
	public int getNroRiga() {
		return nroRiga;
	}

	public void setNroRiga(int nroRiga) {
		this.nroRiga = nroRiga;
	}
}
