...
import it.eng.auriga.ui.module.layout.server.richiestaAccessoAtti.datasource.bean.VisureInIterBean;
import it.eng.auriga.ui.module.layout.server.richiestaAccessoAtti.datasource.bean.VisureInIterXmlBean;
...
public class VisureInIterDatasource extends AbstractFetchDataSource<VisureInIterBean> {

	private static Logger mLogger = Logger.getLogger(VisureInIterDatasource.class);

	@Override
	public PaginatorBean<VisureInIterBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow,
		...
		VisureInIterBean filter = new VisureInIterBean();
		...
		List<VisureInIterXmlBean> lListResult = XmlListaUtility.recuperaLista(xmlOut, VisureInIterXmlBean.class);
		List<VisureInIterBean> lList = new ArrayList<VisureInIterBean>(lListResult.size());
		for (VisureInIterXmlBean lVisureInIterXmlBean : lListResult) {
			VisureInIterBean lVisureInIterBean = new VisureInIterBean();
			BeanUtilsBean2.getInstance().copyProperties(lVisureInIterBean, lVisureInIterXmlBean);
			lList.add(lVisureInIterBean);
		}

		return new PaginatorBean<VisureInIterBean>(lList);
	}
	...
	@Override
	public Map<String, ErrorBean> validate(VisureInIterBean bean) throws Exception {
		return null;
	}
	...
	@Override
	public VisureInIterBean get(VisureInIterBean bean) throws Exception {
		return bean;
	}

	@Override
	public VisureInIterBean add(VisureInIterBean bean) throws Exception {
		return bean;
	}

	@Override
	public VisureInIterBean remove(VisureInIterBean bean) throws Exception {
		return bean;
	}

	@Override
	public VisureInIterBean update(VisureInIterBean bean, VisureInIterBean oldvalue) throws Exception {
		return bean;
	}
