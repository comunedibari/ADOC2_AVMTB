...
public class DirigenteAdottanteItem extends ReplicableItem {
	...
	public ReplicableCanvas getCanvasToReply() {
		DirigenteAdottanteCanvas lDirigenteAdottanteCanvas = new DirigenteAdottanteCanvas();
	...
	public void resetAfterChangedIdUoProponente() {
		for(ReplicableCanvas lReplicableCanvas : getAllCanvas()) {
			((DirigenteAdottanteCanvas)lReplicableCanvas).resetAfterChangedIdUoProponente();
		}	
	}
