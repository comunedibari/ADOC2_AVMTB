...
public abstract class AvvioPropostaAttoDetail extends ProtocollazioneDetailAtti implements TaskFlussoInterface {
						...
						if (rowidDoc != null && !"".equals(rowidDoc)) {
							salvaAttributiDinamiciDoc(false, rowidDoc, activityName, null, new ServiceCallback<Record>() {
								...
								public void execute(Record object) {
									avvioPropostaAtto(idUd, idFolder, idDocPrimario, uoProtocollante, oggetto);
								}
							});
						} else {
	...
	public abstract void avvioPropostaAtto(String idUd, String idFolder, String idDocPrimario, String uoProtocollante, String oggetto);
	...
	public String getNomeTastoSalvaDefinitivo() {
		return isAttiMilano() ? "Avanti" : "Avvia iter";
	}
