...
public class PropostaAtto2Detail extends ProtocollazioneDetailAtti implements TaskFlussoInterface {
	...
	public void visualizzaDatiStorici() {
		...
		if (attributiAddDocTabsDatiStorici != null && attributiAddDocTabsDatiStorici.size() > 0) {
			...
			GWTRestService<Object, Object> lGwtRestService = new GWTRestService<Object, Object>("AttributiDinamiciDatasource");
	...
	protected void compilazioneAutomaticaAnteprimaConCopertina(final DSCallback callback) {
		...
		new GWTRestService<Object, Object>("CompilaModelloDatasource").executecustom("compilaModelloAnteprimaConCopertina", modelloRecord, callback);
	...
	public void compilazioneAutomaticaModelloPdf(Record recordModello, final ServiceCallback<Record> callback) {
		...
		if (recordModello != null) {
			...
			GWTRestService<Object, Object> compilaModelloRestService = new GWTRestService<Object, Object>("CompilaModelloDatasource");
			...
			compilaModelloRestService.call(lRecordCompilaModello, new ServiceCallback<Record>() {
				...
				public void execute(Record result) {
					...
					PreviewWindowWithCallback lPreviewWindow = new PreviewWindowWithCallback(documentUri, false, infoFile, "FileToExtractBean",
							nomeFileModello, new ServiceCallback<Record>() {
								...
								public void execute(Record object) {
									...
									if (flgDaFirmare) {
										...
										FirmaUtility.firmaMultipla(appletTipoFirmaAtti, hsmTipoFirmaAtti, documentUri, nomeFileModello, infoFile, new FirmaCallback() {
	...
	protected void aggiungiModelloAdAllegati(boolean flgParteDispositivo, String descrizioneFileAllegato, String idTipoModello, String nomeTipoModello, String uriFileAllegato,
		...
		if (fileAllegatiForm != null) {
			...
			fileAllegatiItem.resetCanvasChanged();
	...
	public void editRecord(Record record) {
		...
		if (isEseguibile()) {
			if (idTipoTaskDoc != null && !"".equals(idTipoTaskDoc) && nomeTipoTaskDoc != null && !"".equals(nomeTipoTaskDoc)) {
				AllegatoCanvas lAllegatoCanvas = fileAllegatiItem.getAllegatoCanvasFromTipo(idTipoTaskDoc);
				if (lAllegatoCanvas == null) {
					lAllegatoCanvas = (AllegatoCanvas) fileAllegatiItem.onClickNewButton();
	...
	public void salvaDatiDefinitivo() {
		if (validate()) {
			...
			if (nomeAttrCustomEsitoTask != null && !"".equals(nomeAttrCustomEsitoTask)) {
				GWTRestService<Object, Object> lAttributiDinamiciDatasource = new GWTRestService<Object, Object>("AttributiDinamiciDatasource");
				Record lAttributiDinamiciRecord = new Record();
	...
	protected void callbackGetFileDaFirmare(DSResponse response) {
		if (response.getStatus() == DSResponse.STATUS_SUCCESS) {
			...
			String appletTipoFirmaAtti = AurigaLayout.getParametroDB("APPLET_TIPO_FIRMA_ATTI");
			String hsmTipoFirmaAtti = AurigaLayout.getParametroDB("HSM_TIPO_FIRMA_ATTI");
			FirmaUtility.firmaMultipla(appletTipoFirmaAtti, hsmTipoFirmaAtti, records, new FirmaMultiplaCallback() {
