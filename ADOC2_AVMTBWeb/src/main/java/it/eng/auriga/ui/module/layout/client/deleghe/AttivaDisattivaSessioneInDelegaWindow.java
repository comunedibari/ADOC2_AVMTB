...
public class AttivaDisattivaSessioneInDelegaWindow extends Window {
	...
	public AttivaDisattivaSessioneInDelegaWindow() {
		...
		form.setValue("delega", Layout.getUtenteLoggato().getIdUserLavoro());

		manageChangeDelega();
	}

	protected void manageTerminaClick() {
		GWTRestService<Object, Object> lGwtRestServiceTermina = new GWTRestService<Object, Object>("AurigaTerminaDelegaDataSource");
	...
	protected void manageAttivaClick() {
		...
		// Boolean mantieniPreference = (Boolean)form.getValue("mantieniPreference");
		GWTRestService<Object, Object> lGwtRestServiceAttiva = new GWTRestService<Object, Object>("AurigaAttivaDelegaDataSource");
		Record lRecord = new Record();
