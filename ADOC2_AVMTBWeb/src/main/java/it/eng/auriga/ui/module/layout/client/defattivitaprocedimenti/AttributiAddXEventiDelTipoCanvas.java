...
public class AttributiAddXEventiDelTipoCanvas extends ReplicableCanvas {
	...
	protected ImgButtonItem buttonAttributiCustom;
	...
	public void disegna() {
		...
		etichettaAttributo.setWidth(150);
		...
		obbligatorioCheckAttributo.setWidth("*");
		...
		ripetibileCheckAttributo.setWidth("*");
		...
		flgTabPrincipaleItem.setColSpan(1);
		flgTabPrincipaleItem.setWidth("*");
		...
		spacer1.setShowIfCondition(new FormItemIfFunction() {
		...
		mDynamicForm.setFields(nomeAttributo, etichettaAttributo, buttonAttributiCustom, obbligatorioCheckAttributo, ripetibileCheckAttributo, maxNumAttributo,
				flgTabPrincipaleItem, spacer1, codiceItem, labelItem);
