	...
	public VLayout getLayoutTabDatiFolder() {
		...
		operazioniEffettuateButton.addIconClickHandler(new IconClickHandler() {
			...
			public void onIconClick(IconClickEvent event) {
				...
				OperazioniEffettuateWindow operazioniEffettuateWindow = new OperazioniEffettuateWindow(idFolder, "F", I18NUtil.getMessages()
		...
		estremiForm.setItems(idFolderAppItem, idUdFolderItem, flgUdFolderItem, idProcessItem, estremiProcessItem, percorsoFolderAppItem, flgSelXFinalitaItem,
				abilAssegnazioneSmistamentoItem, iterProcessoCollegatoButton, operazioniEffettuateButton, codiceItem, idUdCapofilaItem, capofilaItem,
				apriDettaglioCapofilaButton);
