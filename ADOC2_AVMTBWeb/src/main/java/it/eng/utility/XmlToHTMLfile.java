...
public class XmlToHTMLfile {	
		...
		try {			
			...
			OutputStream htmlFileOutputStreamOut = new FileOutputStream(htmlFileOut);
			StreamResult       htmlFileStreamResultOut = new StreamResult(htmlFileOutputStreamOut);
			...
			lFileToExtractBean.setUri(StorageImplementation.getStorage().storeStream(new FileInputStream(htmlFileOut)));
