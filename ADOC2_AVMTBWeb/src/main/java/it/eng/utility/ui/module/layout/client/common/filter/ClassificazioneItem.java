...
public class ClassificazioneItem extends CustomItem {
	...
	public FilteredSelectItemWithDisplay getSelectItemClassifiche() {
		return classificheItem;
	}

	@Override
	public CustomItemFormField[] getFormFields() {
		
		createClassificazioneSelect();
		
		createFlgIncludiSottoClassificheItem();
		
		createHiddenItem();

		return new CustomItemFormField[] { // Visibili
				                           //indiceCustomItem,
	...
	protected void createClassificazioneSelect() {
	...
	protected void createHiddenItem() {
	...
	private FilteredSelectItemWithDisplay createClassificheFilteredSelectItem(){
        ...
        FilteredSelectItemWithDisplay lFilteredSelectItemWithDisplay = new FilteredSelectItemWithDisplay("classifiche", "Classificazione", lLoadComboClassificaFilterDataSource){
        ...
        lFilteredSelectItemWithDisplay.setPickListFields(idClassificaField, indiceField, descrizioneField);		
        lFilteredSelectItemWithDisplay.setFilterLocally(true);
        lFilteredSelectItemWithDisplay.setValueField("idClassifica");  		
        lFilteredSelectItemWithDisplay.setOptionDataSource(lLoadComboClassificaFilterDataSource); 
