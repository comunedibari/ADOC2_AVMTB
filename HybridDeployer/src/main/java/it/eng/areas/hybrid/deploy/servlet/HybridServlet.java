...
public class HybridServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// FIXME controllare lettura parametri
		...
		if (context != null && context.containsBeanDefinition("HybridPropertyConfigurator") && context.getBean("HybridPropertyConfigurator") != null) {
			HybridPropertyConfigurator hybridConfigBean = (HybridPropertyConfigurator) context.getBean("HybridPropertyConfigurator");
...
//			jars.add("lib/commons-logging-1.1.1.jar");
			...
			// Librerie necessarie per la scansione
			jars.add("lib/mmsc.twain-0.1.jar");
