...
public class ConvertPagesToHiResImages {
    ...
    public  List<File> convertiPdf(String pdfFile,String fileType) throws Exception {
     ...
     * @throws Exception
     */
    public List<File> convertPagesToHiResImages(String fileType, String pdfFile) throws Exception {
        ...
        try{
            ...
            if(separation!=null){
                ...
                output = extractPageAsImage(fileType, outputPath, decoder,"",false);
