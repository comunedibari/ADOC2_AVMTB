...
/**
 * classe di utilità per lo 'smembramento' della email
 * 
 * @author jravagnan
 * 
 */
public class MailBreaker {
	 ...
	 * Se è una PEC le informazioni potrebbero essere recuperate dalla relativa ricevuta completa 
	 * 
	 * @param idEmail
	 * @return
	 * @throws AurigaMailBusinessException
	 ...
	 * Se è una PEC inviata allora il file potrebbe essere recuperato dalla ricevuta completa
	 * 
	 * @param idEmail
	 * @return
	 * @throws Exception
	...
	public MessageInfos getInfosFromIdEmail(String idEmail) throws AurigaMailBusinessException {
		...
		try {
			...
			// se è il flag è true significa che devo restituire le informazioni partendo dalla ricevuta
			if (BooleanUtils.isTrue(emailBean.getFlgUriRicevuta())) {
	 ...
	 * Se è una PEC il corpo potrebbe essere recuperato dalla relativa ricevuta completa
	 * 
	 * @param idEmail
	 * @return
	 * @throws AurigaMailBusinessException
	...
	/**
	 * Metodo che restituisce il corpo della mail più esterna se ha formato text/html, partendo dal file in input
	 * 
	 * @param eml
	 * @return
	 * @throws AurigaMailBusinessException
	...
	/**
	 * Metodo che restituisce il corpo della mail più esterna se ha formato text/html, recuperando il file della mail associata all'id in input. <br>
	 * Se è una PEC il corpo potrebbe essere recuperato dalla relativa ricevuta completa
	 * 
	 * @param eml
	 * @return
	...
	/**
	 * Restituisce corpo text/html se presente fra le parti della mail più esterna
	 * 
	 * @param info
	 * @return
	 * @throws AurigaMailBusinessException
