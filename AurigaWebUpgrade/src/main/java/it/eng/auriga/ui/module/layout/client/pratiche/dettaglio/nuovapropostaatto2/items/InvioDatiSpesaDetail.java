...
//			codiceCIG.setValidators(codiceCIGLengthValidator);
		...
		codiceGAMIPBM = new TextItem("codiceGAMIPBM", I18NUtil.getMessages().nuovaPropostaAtto2_detail_invioDatiSpesaWindow_codiceGAMIPBM_title());
		...
		items.add(descrizioneCapitolo); items.add(titolo); items.add(liv1234PdC);
