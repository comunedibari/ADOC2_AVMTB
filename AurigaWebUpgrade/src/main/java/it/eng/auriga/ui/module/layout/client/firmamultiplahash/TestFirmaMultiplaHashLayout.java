	...
	public TestFirmaMultiplaHashLayout() {
		...
		AllegatiItem lFileItem = new AllegatiItem() {
			...
			public void manageOnClickFirma(String uri, String display, InfoFileRecord infoFile, final FirmaCallback firmaCallback) {
				...
				lCalcolaImpronteService.call(lRecordFiles, new ServiceCallback<Record>() {
					...
					public void execute(Record object) {
						...
						if (lSelectModalitaFirmaItem.getValueAsString() == null || "".equalsIgnoreCase(lSelectModalitaFirmaItem.getValueAsString())
								|| "APPLET".equalsIgnoreCase(lSelectModalitaFirmaItem.getValueAsString())) {
							 ...
							 * degli atti
							 */
							FirmaMultiplaHashWindow lFirmaMultiplaHashWindow = new FirmaMultiplaHashWindow(null, lMap) {
							 ...
							 * degli atti
							 */
							new FirmaMultiplaHashHybridWindow(null, false, lMap, false, object.getAttributeAsString("jSessionId")) {
