...
//				input.setColtoreturnin("1");
		...
		if((bachSize != null && bachSize.intValue() > 0) || (overflowLimit != null && overflowLimit.intValue() > 0)) {			
			HashSet<String> setNumColonneOrdinabili = new HashSet<String>(Arrays.asList("3","5","13","16","23","24","26","27","28","29","30","43","72","73","77","78","79","80","81","82","83","90","91","92","93","94","106","107"));
