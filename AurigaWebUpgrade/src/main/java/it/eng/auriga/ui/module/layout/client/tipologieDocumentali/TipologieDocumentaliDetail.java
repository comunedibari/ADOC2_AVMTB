...
public class TipologieDocumentaliDetail extends CustomDetail {
	...
	private void setInitValues() {
		...
		formTipologiaDocumentale.setItems(idTipoDocItem, nomeItem, descrizioneItem, idDocTypeGenItem, nomeDocTypeGenItem, idProcessTypeItem, flgTipoProvItem, nomeProcessTypeItem);
	}
