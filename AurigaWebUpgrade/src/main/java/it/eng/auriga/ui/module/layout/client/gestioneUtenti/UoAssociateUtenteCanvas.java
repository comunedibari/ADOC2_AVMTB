...
public class UoAssociateUtenteCanvas extends ReplicableCanvas{
	...
	private void buildItems() {		
		...
		codRapidoItem                     = new TextItem("codRapido",               I18NUtil.getMessages().gestioneutenti_uoAssociateUtente_codRapidoItem_title());            codRapidoItem.setTitleOrientation(TitleOrientation.TOP); codRapidoItem.setWidth(80);
	...
	public boolean isVersioneNestle() {
		...
		return (((UoAssociateUtenteItem)getItem()).isVersioneNestle());
	}
