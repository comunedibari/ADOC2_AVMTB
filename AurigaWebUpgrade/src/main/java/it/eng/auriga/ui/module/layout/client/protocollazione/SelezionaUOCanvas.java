...
//				organigrammaDS.addParam("ciToAdd", (String) organigrammaFromLoadDettHiddenItem.getValue());
		...
		mDynamicForm.setFields(idUoHiddenItem, codRapidoItem, descrizioneHiddenItem, lookupOrganigrammaButton, organigrammaItem, organigrammaFromLoadDettHiddenItem);
