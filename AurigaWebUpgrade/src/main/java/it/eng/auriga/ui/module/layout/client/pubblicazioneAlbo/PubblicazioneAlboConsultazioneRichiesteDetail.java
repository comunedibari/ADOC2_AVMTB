    ...
    protected void createFormAtto() {
		...
		statoAttoItem.addChangedHandler(new ChangedHandler() {
			...
			public void onChanged(final ChangedEvent event) {
				...
				if(isAttivoModuloProt() && statoAttoItem.getValue() != null) {
		...
		tipoRegNumItem.setPickListFilterCriteriaFunction(new FormItemCriteriaFunction() {
			...
			public Criteria getCriteria(FormItemFunctionContext itemContext) {
				...
				if(isAttivoModuloProt() && statoAttoItem.getValue().equals("da_caricare")) {
		...
		tipoRegNumItem.setItemHoverFormatter(new FormItemHoverFormatter() {			
			@Override
...
//		// Sigla Registro
		...
		annoRegNumItem.setItemHoverFormatter(new FormItemHoverFormatter() {			
			@Override
			public String getHoverHTML(FormItem item, DynamicForm form) {
				String estremiReg = form.getValueAsString("estremiReg") != null ? form.getValueAsString("estremiReg") : "";
				String datiCollegamento = form.getValueAsString("datiCollegamento") != null ? form.getValueAsString("datiCollegamento") : "";				
		...
		nroRegNumItem.setItemHoverFormatter(new FormItemHoverFormatter() {			
			@Override
			public String getHoverHTML(FormItem item, DynamicForm form) {
	...
	protected void createFormFilePrimario() {
		...
		filePrimarioOmissisItem = new DocumentItem() {
			...
			@Override
			protected boolean showAltreOpOmissis() {
				return true;
			}
...
//		return false;
	 ...
	 * 
	 */
	public boolean isAttivoModuloProt() {
		return AurigaLayout.getParametroDBAsBoolean("ATTIVO_MODULO_PROT");
	}
