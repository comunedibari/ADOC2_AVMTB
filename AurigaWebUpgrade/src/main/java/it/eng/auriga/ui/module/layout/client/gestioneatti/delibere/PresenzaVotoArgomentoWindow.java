...
public class PresenzaVotoArgomentoWindow extends ModalWindow {
	...
	public PresenzaVotoArgomentoWindow(String nomeEntita, String title, final Record record, String tipologiaSessione) {
		...
		detail = new PresenzaVotoArgomentoDetail(nomeEntita, tipologiaSessione);	
		detail.editRecord(record);
		detail.setHeight100();
		detail.setWidth100();
		
		DetailToolStripButton saveButton = new DetailToolStripButton("Salva", "buttons/save.png");
