...
//	private TextItem denominazioneCdCCdR;
	...
	public OrganigrammaDetail(String nomeEntita) {
		...
		lVLayout.addMember(competenzeForm);
	...
	private void creaSelectOrganigrammaSpostaMail() {
		...
		codRapidoSpostaMailItem.setWidth(80);
	...
	private void creaUoLiquidatoreForm() {
		...
		*/
		...
		codRapidoUfficioLiquidatoreItem.setWidth(80);
	...
	private void creaFlgForm() {
	
		formFlg = new DynamicForm();
		formFlg.setWidth(1);
		formFlg.setValuesManager(vm);
		formFlg.setWrapItemTitles(false);
		formFlg.setOverflow(Overflow.VISIBLE);
		formFlg.setNumCols(6);
		...
		flgPuntoRaccoltaEmail.setStartRow(false);
		...
		flgPuntoRaccoltaDocumenti.setStartRow(false);
		...
		flgInibitaAssegnazione.setStartRow(false);
		...
		flgInibitoInvioCC.setEndRow(false);
		...
		flgInibitaAssegnazioneEmail.setEndRow(false);
		...
		inibitaPreimpDestProtEntrataItem.setStartRow(false);
		inibitaPreimpDestProtEntrataItem.setColSpan(3);
		...
		storicizzaDatiVariatiIn.setEndRow(true);
		storicizzaDatiVariatiIn.setColSpan(1);
		...
		formFlg.setFields(spacerItem,flgPuntoDiProtocollo,flgPuntoRaccoltaEmail,flgPuntoRaccoltaDocumenti,
				          spacerItem,flgInibitaAssegnazione,flgInibitoInvioCC,flgInibitaAssegnazioneEmail,
				          spacerItem,inibitaPreimpDestProtEntrataItem,
				          spacerItem,storicizzaDatiVariatiIn 
				);
	}
	...
	private void creaMainForm() {
		...
		denominazioneEstesa.setWidth(675);
		...
		denominazioneBreve.setEndRow(false);
		denominazioneBreve.setWidth(400);
		denominazioneBreve.setColSpan(6);	
				
		/*
		denominazioneCdCCdR = new TextItem("denominazioneCdCCdR", setTitleAligned(I18NUtil.getMessages().organigramma_uo_detail_denominazioneCdCCdR_title()));
		...
		*/
		...
		form.setFields(idUoSvUt,tipo, denominazioneEstesa, denominazioneBreve, /*denominazioneCdCCdR,*/
				idAssessoreRif, presenteAttoDefOrganigrammaItem,dataIstituitaItem, dataCessazioneItem);
