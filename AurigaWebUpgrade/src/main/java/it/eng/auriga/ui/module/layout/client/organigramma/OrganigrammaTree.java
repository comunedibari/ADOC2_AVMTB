...
//			}
		...
		if (AurigaLayout.getParametroDBAsBoolean("ATTIVA_GEST_PUNTI_PROT")) {
			setFields(idFolder, idUoSvUt, tipo, codRapidoUo, nroLivello, nroProgr, nome, flgSelXAssegnazione, iconeRiga);
		} else {
			setFields(idFolder, idUoSvUt, tipo, codRapidoUo, nroLivello, nroProgr, flgSelXAssegnazione, nome, iconeRiga);
		}
