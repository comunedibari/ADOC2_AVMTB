...
public abstract class AssegnaStatoUdPopup extends Window {
	...
	public AssegnaStatoUdPopup(String title, boolean required, String finalita){
		...
		setTitle(title != null && !"".equals(title) ? title : "Assegna stato");
		setShowTitle(true);
		...
		// Stato
		GWTRestDataSource statoUdDS = new GWTRestDataSource("LoadComboStatoDettUdDataSource", "key", FieldType.TEXT);
		if(finalita != null && !"".equals(finalita)) {
			statoUdDS.addParam("finalita", finalita);
		}
