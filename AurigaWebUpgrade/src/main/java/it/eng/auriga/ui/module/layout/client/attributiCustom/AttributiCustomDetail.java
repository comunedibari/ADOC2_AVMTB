...
public class AttributiCustomDetail extends CustomDetail {
	...
	public AttributiCustomDetail(String nomeEntita) {
		...
		formatNumberItem.setItemHoverFormatter(new FormItemHoverFormatter() {
		...
		formDettaglioAttributo.setItems(nroOrdineItem, nroRigaInAttrAppInItem, maxNumeroCaratteriItem, larghezzaVideoCaratteriItem, formatNumberItem,
				nrDecimaleItem, defaultValueItem, altezzaVideoCaratteriItem, numMinValue, maxNumeroCifreItem, defaultDateValue, minDateItem, maxDateItem,
				...
				uRLWSValoriPossibiliInItem, xMLInWSValoriPossibiliInItem, lOpzioniListaSceltaAttributiCustomItem);
