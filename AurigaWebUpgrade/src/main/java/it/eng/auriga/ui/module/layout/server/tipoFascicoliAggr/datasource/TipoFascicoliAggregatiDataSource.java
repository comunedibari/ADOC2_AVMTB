...
public class TipoFascicoliAggregatiDataSource extends AbstractFetchDataSource<TipoFascicoliAggregatiBean> {
	...
	private static final Logger log = Logger.getLogger(TipoFascicoliAggregatiDataSource.class);
	...
	public PaginatorBean<TipoFascicoliAggregatiBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby)
		...
		log.info("start search tipo fascic aggregati");
	...
	public TipoFascicoliAggregatiBean add(TipoFascicoliAggregatiBean bean) throws Exception {
		...
		log.info("start save tipologia fascicoli aggregati");
		AurigaLoginBean loginBean = AurigaUserUtil.getLoginInfo(getSession());
		...
		log.info("end save tipologia fascicoli aggregati");
		return bean;
	}
	...
	public TipoFascicoliAggregatiBean update(TipoFascicoliAggregatiBean bean, TipoFascicoliAggregatiBean oldvalue) throws Exception {
		...
		log.info("start update tipologia fascicoli aggregati");
		AurigaLoginBean loginBean = AurigaUserUtil.getLoginInfo(getSession());
		...
		log.info("end update tipologia fascicoli aggregati");
		return bean;
	}
	...
	public TipoFascicoliAggregatiBean get(TipoFascicoliAggregatiBean bean) throws Exception {
		...
		log.info("start get tipologia fascicoli aggregati");
		AurigaLoginBean loginBean = AurigaUserUtil.getLoginInfo(getSession());
		...
		result.setPeriodoConservInAnni(output.getResultBean().getPeriodoconservout() != null && output.getResultBean().getPeriodoconservout().intValue() != 0 ? output
		...
		result.setFlgRichAbilXVisualizz(output.getResultBean().getFlgrichabilxvisualizzout() != null
				&& output.getResultBean().getFlgrichabilxvisualizzout() == 1 ? true : false);
		result.setFlgRichAbilXGest(output.getResultBean().getFlgrichabilxgestout() != null && output.getResultBean().getFlgrichabilxgestout() == 1 ? true
				: false);
		result.setFlgRichAbilXAssegn(output.getResultBean().getFlgrichabilxassegnout() != null && output.getResultBean().getFlgrichabilxassegnout() == 1 ? true
				: false);
		...
		result.setIdClassificazione(output.getResultBean().getIdclassificazioneout() != null ? "" + output.getResultBean().getIdclassificazioneout().longValue()
				: null);
		...
		log.info("end get tipologia fascicoli aggregati");
		return result;
	}
	...
	public TipoFascicoliAggregatiBean remove(TipoFascicoliAggregatiBean bean) throws Exception {
		...
		log.info("start remove tipologia fascicoli aggregati");
		AurigaLoginBean loginBean = AurigaUserUtil.getLoginInfo(getSession());
