...
public class InvioNotificaInteropForm extends DynamicForm {
	...
	public InvioNotificaInteropForm() {
		...
		CustomValidator lCustomValidator = buildCustomValidator();
		buildDestinatariItem(lCustomValidator);
		...
		// Destinatari CC
		buildDestinatariCCItem(lCustomValidator);
...
//	}
	...
	private CustomValidator buildCustomValidator() {
