...
public class InvioUDMailForm extends DynamicForm {
	...
	public InvioUDMailForm(String pTipoMail) {
...
//		setCellBorder(1);
		...
		createDestinatariCC(lCustomValidator);
		
		// Creazione filtro destinatari
		creaFiltroDestinatariCCN();
		
		createDestinatariCCN(lCustomValidator);
		...
		setFields(
			idCasellaMittenteItem,lSelectItemMittente,salvaMittenteDefaultImgButton,
...
//		});
	...
	private void createMittente() {
		...
		//lSelectItemMittente.setDefaultToFirstOption(false);
