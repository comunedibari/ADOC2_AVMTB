...
public class XmlFilterPostaElettronicaBean {
	...
	/**
	 * @param nomeFileAssociato
	 *            the nomeFileAssociato to set
	 */
	...
	/**
	 * @param operFileAssociato
	 *            the operFileAssociato to set
	 */
