...
public class InvioMailForm extends DynamicForm {
	...
	private void createDestinatariPrimari() {
		...
		lComboBoxDestinatari.setItemHoverFormatter(new FormItemHoverFormatter() {

			@Override
			public String getHoverHTML(FormItem item, DynamicForm form) {

				return (String) lComboBoxDestinatari.getValue();
			}
		});
	...
	private void createDestinatariCC() {
		...
		lComboBoxDestinatariCC.setItemHoverFormatter(new FormItemHoverFormatter() {

			@Override
			public String getHoverHTML(FormItem item, DynamicForm form) {

				return (String) lComboBoxDestinatariCC.getValue();
			}
		});
		...
		/*
		 * Il lCustomValidatorDestinatariCC è stato creato perchè, utilizzando sia per i destinatari che per i destinatariCC lo stesso CustomValidator, viene
		 * generata un'umbrellaException.
		 */
		CustomValidator lCustomValidatorDestinatariCC = new CustomValidator() {
		...
		lCustomValidatorDestinatariCC.setErrorMessage(I18NUtil.getMessages().invionotificainteropform_destinatariValidatorErrorMessage());

		lComboBoxDestinatariCC.setValidators(lCustomValidatorDestinatariCC);
...
//		});
	...
	private void createDestinaratiCCN() {
		...
		lComboBoxDestinatariCCN.setItemHoverFormatter(new FormItemHoverFormatter() {

			@Override
			public String getHoverHTML(FormItem item, DynamicForm form) {

				return (String) lComboBoxDestinatariCCN.getValue();
			}
		});
		 ...
		 * generata un'umbrellaException.
		 */
		CustomValidator lCustomValidatorDestinatariCCN = new CustomValidator() {
		...
		lCustomValidatorDestinatariCCN.setErrorMessage(I18NUtil.getMessages().invionotificainteropform_destinatariValidatorErrorMessage());

		lComboBoxDestinatariCCN.setValidators(lCustomValidatorDestinatariCCN);
