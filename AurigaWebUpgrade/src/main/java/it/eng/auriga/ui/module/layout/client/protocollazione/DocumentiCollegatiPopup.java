...
public class DocumentiCollegatiPopup extends ModalWindow {
	...
	public DocumentiCollegatiPopup(Record pRecord){
		...
		_form.setFields(new FormItem[]{idUdHiddenItem, documentiCollegatiItem});		
					...
					lGwtRestDataSourceProtocollo.addData(lRecord, new DSCallback() {
						...
						public void execute(DSResponse response, Object rawData, DSRequest request) {
							if(response.getStatus() == DSResponse.STATUS_SUCCESS) {					
								Layout.addMessage(new MessageBean("Documenti collegati modificati con successo", "", MessageType.INFO));
								GWTRestDataSource lGwtRestDataSourceProtocollo = new GWTRestDataSource("DocumentiCollegatiDataSource");
								...
								lGwtRestDataSourceProtocollo.getData(lRecordToLoad, new DSCallback() {
									...
									public void execute(DSResponse response, Object rawData, DSRequest request) {
										...
										RecordList listaDocumentiCollegati = lDetailRecord.getAttributeAsRecordList("listaDocumentiCollegati");
								...
								Layout.addMessage(new MessageBean("Si è verificato un errore durante il salvataggio dei documenti collegati", "", MessageType.ERROR));
							}									
						}
					});					
				}
