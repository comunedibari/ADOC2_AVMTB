...
public class AttiAutorizzazioneAnnRegList extends CustomList {
	...
	public AttiAutorizzazioneAnnRegList(String nomeEntita) {
		...
		idAttoField = new ListGridField("idAtto");
		idAttoField.setHidden(true);
		idAttoField.setCanHide(false);	

		nroBozzaField = new ListGridField("nroBozza", "Bozza N°");
		
		nroAttoField = new ListGridField("nroAtto", "Atto N°");
		
		tsRegBozzaField = new ListGridField("tsRegBozza", "Creato il");	
		tsRegBozzaField.setType(ListGridFieldType.DATE);
		tsRegBozzaField.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATETIME);
		
		oggettoField = new ListGridField("oggetto", "Oggetto");
		
		tsRegAttoField = new ListGridField("tsRegAtto", "Chiuso il");	
		tsRegAttoField.setType(ListGridFieldType.DATE);
		tsRegAttoField.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATETIME);
...
//		boolean isAttoChiuso = record.getAttribute("flgAttoChiuso") != null && "1".equals(record.getAttribute("flgAttoChiuso"));		
//		if (fieldName.equals("chiudiAtto")) {				
//			if(!isAttoChiuso) {
//				ImgButton chiudiAttoButton = new ImgButton();   
//				chiudiAttoButton.setShowDown(false);   
//				chiudiAttoButton.setShowRollOver(false);      
//				chiudiAttoButton.setSrc("attiAutorizzazione/chiudiAtto.png");   
//				chiudiAttoButton.setPrompt("Chiudi atto");   
//				chiudiAttoButton.setSize(16);  
//				chiudiAttoButton.addClickHandler(new ClickHandler() {   
...
//				recordCanvas.setMembers(chiudiAttoButton);
