...
public class NuovaRegolaCampionamentoPopup extends ModalWindow {
	...
	private GruppiAttiCampionamentoGridItem listaGruppiAttiCampionamentoItem;
...
//		layout.addMember(spacerLayout);
	...
	private void buildRegoleCampionamentoForm() {
		...
		listaGruppiAttiCampionamentoItem = new GruppiAttiCampionamentoGridItem("listaGruppiAttiCampionamento") {
