...
public class ListaDatiDiscussionePrimaConvocazioneItem extends GridItem {
	...
	public ListaDatiDiscussionePrimaConvocazioneItem(String name,String tipologiaSessione, Boolean isEditabile) {
	...
	public void setGridFields(ListGridField... fields) {
		...
		ListaBean configLista = Layout.getListConfig("lista_dati_discussione_prima_convocazione");
