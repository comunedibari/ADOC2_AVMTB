...
public class ArchivioDatasource extends AurigaAbstractFetchDatasource<ArchivioBean> {
	...
	public ArchivioBean get(ArchivioBean bean) throws Exception {
		...
		if (loadFascicoloOut.isInError()) {
			...
			result.setIdTopografico(lXmlFascicoloOut.getCollocazioneFisica() != null ? lXmlFascicoloOut.getCollocazioneFisica().getIdTopografico() : null); // ID
																																							// TOPOGRAFICO
			result.setCodRapidoTopografico(lXmlFascicoloOut.getCollocazioneFisica() != null ? lXmlFascicoloOut.getCollocazioneFisica().getCodRapido() : null); // CODICE
																																								// RAPIDO
																																								// TOPOGRAFICO
			result.setNomeTopografico(lXmlFascicoloOut.getCollocazioneFisica() != null ? lXmlFascicoloOut.getCollocazioneFisica().getDescrizione() : null); // NOME
																																							// TOPOGRAFICO
			...
			result.setAbilAssegnazioneSmistamento(lXmlFascicoloOut.getAbilitazioni() != null ? lXmlFascicoloOut.getAbilitazioni().getAssegnazioneSmistamento()
					: null);
			...
			if (lXmlFascicoloOut.getListaDocumentiIniziali() != null && lXmlFascicoloOut.getListaDocumentiIniziali().size() > 0) {
				...
				for (AllegatiOutBean documento : lXmlFascicoloOut.getListaDocumentiIniziali()) {
					recuperaDocumento(listaDocumentiIniziali, documento);
				}
			...
			if (lXmlFascicoloOut.getListaDocumentiIstruttoria() != null && lXmlFascicoloOut.getListaDocumentiIstruttoria().size() > 0) {
				...
				for (AllegatiOutBean documento : lXmlFascicoloOut.getListaDocumentiIstruttoria()) {
					recuperaDocumento(listaDocumentiIstruttoria, documento, lXmlFascicoloOut.getDictionaryEntrySezione());
				}
	...
	public ArchivioBean update(ArchivioBean bean, ArchivioBean oldvalue) throws Exception {
		...
		if (StringUtils.isNotBlank(modificaFascicoloOut.getDefaultMessage())) {
...
//					}
	...
	public ArchivioBean add(ArchivioBean bean) throws Exception {
		...
		if (StringUtils.isNotBlank(salvaFascicoloOut.getDefaultMessage())) {
	...
	public FirmaMassivaFilesBean aggiornaDocumentoFirmato(FirmaMassivaFilesBean pFirmaMassivaFilesBean) throws Exception {
		...
		for (FileDaFirmareBean lFileDaFirmareBean : pFirmaMassivaFilesBean.getFiles()) {
			try {
				...
				if (!firmaEseguita || !FirmaUtility.isSigned(lFile.toURI().toString(), lFile.getName())){
...
//		return exportBean;
	...
	protected FindRepositoryObjectBean createFindRepositoryObjectBean(AdvancedCriteria criteria, AurigaLoginBean loginBean) throws Exception {
		...
		String colsToReturn = "1,2,3,4,5,6,7,10,14,15,16,17,18,20,29,30,32,33,36,37,39,42,53,72,88,89,90,91,92,93,94,95,96,97,99,100,201,203,204,205,206,207,208,209,214,215,216,227,232,258,259,260,261,263,281,282,284,285,CAUSALE_AGG_NOTE,FLG_IMMEDIATAMENTE_ESEGUIBILE,DES_PERIZIA_ADSP,FLG_SOTTOPOSTO_CONTROLLO_REG_AMM,ID_PROCESS_CONTROLLO_REG_AMM";
		...
		String colsOrderBy = "201";
		String flgDescOrderBy = "1";
		...
		if (StringUtils.isNotBlank(statiFolder)) {
			...
			scCriteriAvanzati.setStatiFolder(listaStatiFolder);
