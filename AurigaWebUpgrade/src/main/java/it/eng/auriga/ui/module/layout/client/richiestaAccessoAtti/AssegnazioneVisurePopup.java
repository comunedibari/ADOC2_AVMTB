...
public abstract class AssegnazioneVisurePopup extends ModalWindow {
	...
	public AssegnazioneVisurePopup(Record pListRecord){
		
		super("assegnazione_visure", true);
		
		_window = this;
		
		String estremiProcedimento = (pListRecord != null && pListRecord.getAttribute("documentoInizialeProcedimento") != null) ? "visura SUE richiesta " + pListRecord.getAttribute("documentoInizialeProcedimento") : "";
		String title = null;
