...
import it.eng.auriga.ui.module.layout.client.protocollazione.AltriDatiRicezionePopup;
...
//				}				
		...
		gruppiDS.extraparam.put("usaFlagSoggettiInterni", "S");
		...
		opzioniAccessoValueMap.put("V+E", "anche esecuzione");			
		opzioniAccessoItem.setDefaultValue("V+E");		
		...
		mDynamicForm.setFields(
				...
				idRuoloProcSvRuoloAmmItem, descrRuoloProcSvRuoloAmmItem, altriDatiRuoliAmmButton, ruoliAttSoggIntProcItem, opzioniAccessoItem
		);
