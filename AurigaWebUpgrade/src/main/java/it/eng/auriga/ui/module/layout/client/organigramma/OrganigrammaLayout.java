...
public class OrganigrammaLayout extends CustomAdvancedTreeLayout {
	...
	public OrganigrammaLayout(String finalita, Boolean flgSelezioneSingola, Boolean flgSoloFolder, final String idRootNode, Integer flgIncludiUtenti,
		...
		super("organigramma", getOrganigrammaTreeDatasource(finalita, idUd), getOrganigrammaDataSource(finalita, idUd), new OrganigrammaTree("organigramma"),
		...
		// altrimenti mostro la combo degli organigrammi, il check flgSoloAttive (di default a true) e le relazioni degli utenti
			...
			lLinkedHashMapTipoRelUtentiConUO.put("L", "gestione documentazione assegnata/inviata");
	...
	public static GWTRestDataSource getOrganigrammaTreeDatasource(String finalita, String idUd) {
	...
	public static GWTRestDataSource getOrganigrammaDataSource(String finalita, String idUd) {
	...
	public void manageNewClick() {
		this.setMode("edit");
		if (!(detail instanceof OrganigrammaDetail)) {
			this.changeDetail(getOrganigrammaDataSource(finalita, idUd), new OrganigrammaDetail("organigramma"));
		}
