...
public class CriteriAvanzati implements Serializable {
	...
	public void setNewsConNotificheCondivisione(
			String newsConNotificheCondivisione) {
	...
	public void setNewsConNotificheAutomatiche(
			String newsConNotificheAutomatiche) {
	...
	public void setStatiRichiestaAnnullamentoReg(
			List<StatoRichAnnullamentoReg> statiRichiestaAnnullamentoReg) {
	...
	public void setMezziTrasmissione(
			List<MezziTrasmissioneFilterBean> mezziTrasmissione) {
	...
	public void setDataAcquisizioneInConservazioneDa(
			Date dataAcquisizioneInConservazioneDa) {
	...
	public void setDataAcquisizioneInConservazioneA(
			Date dataAcquisizioneInConservazioneA) {
	...
	public void setFlgProlungatoTempoConservazione(
			String flgProlungatoTempoConservazione) {
	...
	public void setFlgRichiestaEsibizioneAlConservatore(
			String flgRichiestaEsibizioneAlConservatore) {
