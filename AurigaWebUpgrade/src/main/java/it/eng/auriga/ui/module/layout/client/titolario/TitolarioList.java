...
public class TitolarioList extends CustomList {
	...
	public TitolarioList(final String nomeEntita) {
		...
		setFields(folderUp, icona, iconaFlgClassificaChiusa, idClassificazione, tipo, descrizione, descrizioneEstesa, paroleChiave, indice, indiceXOrd, tsValidaDal, tsValidaFinoAl,
				idClassificaSup, desClassificaSup, flgSelXFinalita, score, periodoConservAnni);
