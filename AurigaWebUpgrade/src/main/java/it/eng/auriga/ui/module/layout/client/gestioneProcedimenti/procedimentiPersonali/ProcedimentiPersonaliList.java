...
public class ProcedimentiPersonaliList extends CustomList {
	...
	public ProcedimentiPersonaliList(String nomeEntita) {
		...
		ultimoTaskProcedimentoField             = new ListGridField("ultimoTaskProcedimento",           I18NUtil.getMessages().procedimenti_personali_list_ultimoTaskProcedimentoField());
		messaggioUltimoTaskProcedimentoField    = new ListGridField("messaggioUltimoTaskProcedimento",  I18NUtil.getMessages().procedimenti_personali_list_messaggioUltimoTaskProcedimentoField());
...
//		downloadFileAllegatoMenuItem.setEnabled(PreviewWindow.canBePreviewed(lInfoFileRecord));
...
//		lGwtRestDataSource.executecustom("mandaALibroFirmaDaProcedimentiPersonali", recordToSave, new DSCallback() {
//
//			public void execute(DSResponse response, Object rawData, DSRequest request) {
//				if (response.getStatus() == DSResponse.STATUS_SUCCESS) {
...
//
//		GWTRestDataSource lGwtRestDataSource = new GWTRestDataSource("AzioniLibroFirmaDataSource");
//		lGwtRestDataSource.executecustom("togliDaLibroFirmaDaProcedimentiPersonali", recordToSave, new DSCallback() {
//
//			public void execute(DSResponse response, Object rawData, DSRequest request) {
//				if (response.getStatus() == DSResponse.STATUS_SUCCESS) {
//					Record data = response.getData()[0];
