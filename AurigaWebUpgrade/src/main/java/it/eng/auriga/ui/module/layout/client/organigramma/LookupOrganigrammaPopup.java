...
//			}		
		...
		portletLayout = new OrganigrammaLayout(getFinalita(), flgSelezioneSingola, true, idRootNode, flgIncludiUtenti, null, null, getFlgSoloAttive(), null, initialCriteria, getIdUd()) {
