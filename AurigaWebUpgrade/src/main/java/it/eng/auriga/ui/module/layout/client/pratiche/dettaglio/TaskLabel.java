...
public class TaskLabel extends Label {
	...
	public TaskLabel(String titolo, String dettagli, String motiviNonEseg, String icon, final String flgFatta, final String flgEsito, String flgDisponibile, final String flgToDo, DettaglioPraticaLayout pDettaglioPraticaLayout) {
		...
		addHoverHandler(new HoverHandler() {
			...
			public void onHover(HoverEvent event) {
				...
				setPrompt(dettaglioPraticaLayout.getPromptIconaVoceMenu(flgFatta, flgEsito, flgToDo));
			}
		});
