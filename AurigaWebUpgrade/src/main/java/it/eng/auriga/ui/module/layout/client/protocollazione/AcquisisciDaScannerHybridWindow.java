...
public class AcquisisciDaScannerHybridWindow extends HybridWindow {
	...
	public AcquisisciDaScannerHybridWindow(ScanCallback returnCallback) {
		...
		HybridEng lAppletEng = new HybridEng("ScanApplet", "ScanApplet.jnlp", lMapParams, 490, 320, true, true, this, new String[] { "ScanApplet.jar" },
				"it.eng.utility.scanner.twain.applet.TwainApplet") {
