...
//		});
	...
	public void showRowContextMenu(final ListGridRecord listGridRecord, final Menu navigationContextMenu, final Boolean flgFileRichiesto) {
		...
		GWTRestDataSource lArchivioDatasource = new GWTRestDataSource("ProtocolloDataSource", "idUdFolder", FieldType.TEXT);
		lArchivioDatasource.addParam("flgSoloAbilAzioni", "1");
