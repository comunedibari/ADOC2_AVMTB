...
public class ModelliUtil {
	...
	public static FileDaFirmareBean fillFreeMarkerTemplateWithModel(String idProcess, String idModello, Map<String, Object> model, Boolean flgConvertToPdf, Boolean flgMostaDatiSensibili, HttpSession session) throws Exception {
		return fillFreeMarkerTemplateWithModel(idProcess, idModello, model, flgConvertToPdf, flgMostaDatiSensibili, false, session);
	}
	
	public static FileDaFirmareBean fillFreeMarkerTemplateWithModel(String idProcess, String idModello, Map<String, Object> model, Boolean flgConvertToPdf, Boolean flgMostaDatiSensibili, Boolean flgMostraOmissisBarrati, HttpSession session) throws Exception {
