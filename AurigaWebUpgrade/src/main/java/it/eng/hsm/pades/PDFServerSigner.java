...
import it.eng.hsm.cades.CustomContentSigner;
...
public class PDFServerSigner {
	...
	public ByteArrayOutputStream generaPdf(byte[] data, X509Certificate userCert, Hsm client, boolean visualizzaFirmaPades,
...
//			InputStream fis = new ByteArrayInputStream(StreamUtils.loadBytes(sap.getRangeStream()));
			...
			AttributeTable attributeTable = FirmaCadesUtil.generateSignedAttributes(contentDigest, certDigest);
	...
	public FileElaborate calcolaHashPdf(byte[] data, X509Certificate userCert, Hsm client, boolean visualizzaFirmaPades,
			RettangoloFirmaPadesBean rettangoloFirmaPadesBean) throws HsmClientSignatureException {
