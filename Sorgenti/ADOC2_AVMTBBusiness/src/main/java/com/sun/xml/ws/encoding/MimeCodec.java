...
abstract class MimeCodec implements Codec {
    ...
    public void decode(InputStream in, String contentType, Packet packet) throws IOException {
    	...
    	if(packet.component instanceof ServletAdapter) {
    		// Vado a recuperare il servizio chiamato analizzando il packet.component solo se � di tipo ServletAdapter (il component cambia a seconda del giro di elaborazione request/response)
    		ServletAdapter ad = (ServletAdapter) packet.component;
    		serviceName = OrderAttachServicesEnum.fromValue(ad.getName());
    	}
    	
    	// se � stato trovato un enum di un servizio dove applicare l'ordinamento degli attach (quindi serviceName risulta valorizzato), 
    	// allora si attiver� la procedura  di cambio header per la gestione dell'ordinamento. 
