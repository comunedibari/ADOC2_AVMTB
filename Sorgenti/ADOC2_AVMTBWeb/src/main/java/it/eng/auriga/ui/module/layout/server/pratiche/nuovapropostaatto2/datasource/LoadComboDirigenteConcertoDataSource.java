...
@Datasource(id = "LoadComboDirigenteConcertoDataSource")
public class LoadComboDirigenteConcertoDataSource extends SelectDataSource<ScrivaniaOrganigrammaBean> {
	...
	public PaginatorBean<ScrivaniaOrganigrammaBean> realFetch(AdvancedCriteria criteria, Integer startRow,
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DES_RUOLO|*|$DIRIGENTE$|*|CI_TO_ADD|*|" + idSv);
