	...
	protected void createMittentiItem() {
		...
		mittentiItem = new MittenteProtInternaItem() {
			...
			public boolean hasDefaultValue() {
				...
				return AurigaLayout.getParametroDBAsBoolean("PREIMP_UO_COME_MITT_BOZZE") && (AurigaLayout.getUoProtocollantiValueMap().size() == 1)
...
//			}
	...
	public void modificaDatiMode(Boolean abilAggiuntaFile) {
		...
		if (abilAggiuntaFile) {
			fileAllegatiItem.setAggiuntaFileMode();
		} else {
