...
public class IstanzeDetail extends ProtocollazioneDetailBozze {
	...
	protected void createDetailSectionDataEOraRicezione() {
		...
		detailSectionDataEOraRicezione = new ProtocollazioneHeaderDetailSection(I18NUtil.getMessages().protocollazione_detail_datiRicezioneForm_title(), true, true, true, datiRicezioneForm);
	}
	...
	protected void createDatiRicezioneForm() {
		...
		datiRicezioneForm.setNumCols(4);
		datiRicezioneForm.setColWidths(140, 300, "*", "*");
		...
		datiRicezioneForm.setFields(dataEOraRicezioneItem);
	}
