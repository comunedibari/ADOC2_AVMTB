...
public class GruppiSoggettiDetail extends CustomDetail { 
	...
	// CheckboxItem
	private CheckboxItem 	flgCreatodameItem;			// flag creato da me
	private CheckboxItem 	flgValidoItem;           	// flag valido
	...
	public GruppiSoggettiDetail(String nomeEntita) {		
        ...
        datiPrincipaliForm.setNumCols(16);
        datiPrincipaliForm.setColWidths("1" , "1", "*");
        ...
        validitaForm.setNumCols(16);
        validitaForm.setColWidths("1" , "1", "*");
        ...
        // Aggiungo gli item al form
        validitaForm.setItems(dtValiditaDaItem, dtValiditaAItem);
