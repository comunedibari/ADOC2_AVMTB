	...
	public void disegna() {
		...
		dettaglioAttributoCustomButton.setShowIfCondition(new FormItemIfFunction() {
			...
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				...
				return nomeAttributoCustom != null && !"".equals(nomeAttributoCustom);
			}
		});
...
//		});
		...
		associazioniSottoAttributiComplexButton.setShowIfCondition(new FormItemIfFunction() {
			...
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				boolean flgComplex = mDynamicForm.getValue("flgComplex") != null && (Boolean) mDynamicForm.getValue("flgComplex");
				String nomeAttributoCustom = (String) mDynamicForm.getValue("nomeAttributoCustom");
				return flgComplex && nomeAttributoCustom != null && !"".equals(nomeAttributoCustom);
			}
		});
		associazioniSottoAttributiComplexButton.addIconClickHandler(new IconClickHandler() {
			...
			public void onIconClick(IconClickEvent event) {
				Record record = new Record(mDynamicForm.getValues());
				AssociazioniSottoAttributiComplexPopup associazioniSottoAttributiComplexPopup = new AssociazioniSottoAttributiComplexPopup("Associazioni con i sotto-attributi di " + mDynamicForm.getValue("nomeAttributoCustom"), ((AssociazioniAttributiCustomItem) getItem()).getNomeTabella(), ((AssociazioniAttributiCustomItem) getItem()).getIdEntitaAssociata(), record) {
...
//		tipoBarcodeValueMap.put("DATAMATRIX", "DataMatrix");
		...
		mDynamicForm.setFields(nomeVariabileModelloItem, aliasVariabileModelloItem, flgComplexItem, flgRipetibileItem, flgImageItem, nomeAttributoCustomItem, /*lookupAttributiCustomButton,*/ dettaglioAttributoCustomButton, associazioniSottoAttributiComplexItem, associazioniSottoAttributiComplexButton, flgBarcodeItem, tipoBarcodeItem);	
	...
	public boolean showFlgBarcode() {
		...
		return nomeAttributoCustom != null && !"".equals(nomeAttributoCustom) && !flgComplex && flgImage;	
	}
