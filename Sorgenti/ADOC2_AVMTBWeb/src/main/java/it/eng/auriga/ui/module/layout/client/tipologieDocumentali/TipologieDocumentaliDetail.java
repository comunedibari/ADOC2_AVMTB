...
public class TipologieDocumentaliDetail extends CustomDetail {
	...
	public TipologieDocumentaliDetail(String nomeEntita) {
		...
		detailSectionAttributiCustom = new DetailSection(I18NUtil.getMessages().tipologieDocumentali_detail_section_attr_custom(), true, true, false,
	...
	private void setInitValues() {
		...
		formTipologiaDocumentale.setItems(idTipoDocItem, nomeItem, descrizioneItem, idDocTypeGenItem, nomeDocTypeGenItem, idProcessTypeItem, nomeProcessTypeItem);
	}
	...
	private void setAbilValues() {
		...
		periodoConservInItem.setShowIfCondition(new FormItemIfFunction() {
			...
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				Boolean flgConservIllimitata = (Boolean) formAbilitazioni.getValue("flgConservPermIn");
				return flgConservIllimitata == null || !flgConservIllimitata;
			}
		});

		formAbilitazioni.setItems(spacer, flgRichAbilVisItem, flgRichAbilXGestInItem, flgRichAbilXAssegnInItem, flgAbilFirmaItem, flgConservPermInItem,
