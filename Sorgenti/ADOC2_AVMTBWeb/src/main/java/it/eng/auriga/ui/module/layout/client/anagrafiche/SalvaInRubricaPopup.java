...
public abstract class SalvaInRubricaPopup extends ModalWindow {
	...
	public SalvaInRubricaPopup(String finalita, Record recordMittente, Record recordIndirizzo) {
		...
		buildValuesFormSoggetti(detail, recordMittente, recordIndirizzo);

		setIcon("menu/soggetti.png");

	}

	public void buildValuesFormSoggetti(SoggettiDetail detail, Record recordMittente, Record recordIndirizzo) {
		String tipo = recordMittente.getAttributeAsString("tipo");
		String denominazione = recordMittente.getAttributeAsString("denominazione");
		String cognome = recordMittente.getAttributeAsString("cognome");
		String nome = recordMittente.getAttributeAsString("nome");
		String codRapido = recordMittente.getAttributeAsString("codRapido");
		String codiceFiscale = recordMittente.getAttributeAsString("codiceFiscale");
