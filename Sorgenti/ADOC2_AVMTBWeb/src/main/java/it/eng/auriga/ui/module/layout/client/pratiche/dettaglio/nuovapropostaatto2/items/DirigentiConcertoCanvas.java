...
public class DirigentiConcertoCanvas extends ReplicableCanvas {
	...
	private SelectItemWithDisplay dirigenteConcertoItem;
	...
	public void disegna() {
		...
		SelectGWTRestDataSource dirigenteConcertoDS = new SelectGWTRestDataSource("LoadComboDirigenteConcertoDataSource", "idSv", FieldType.TEXT, new String[]{"codUo", "descrizione"}, false);
		
		dirigenteConcertoItem = new SelectItemWithDisplay("dirigenteConcerto", I18NUtil.getMessages().nuovaPropostaAtto2_detail_dirigenteConcerto_title(), dirigenteConcertoDS) {
		...
		dirigenteConcertoItem.setWidth(500);
		...
		flgDirigenteConcertoFirmatarioItem = new CheckboxItem("flgDirigenteConcertoFirmatario", I18NUtil.getMessages().nuovaPropostaAtto2_detail_flgDirigenteConcertoFirmatario_title());
		...
		mDynamicForm.setFields(dirigenteConcertoItem, codUoDirigenteConcertoHiddenItem, desDirigenteConcertoHiddenItem, flgDirigenteConcertoFirmatarioItem);	
