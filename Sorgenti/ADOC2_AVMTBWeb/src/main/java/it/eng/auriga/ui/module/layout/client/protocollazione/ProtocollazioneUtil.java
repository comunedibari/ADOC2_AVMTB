...
public class ProtocollazioneUtil {
	...
	public static ProtocollazioneDetailBozze buildProtocollazioneDetailBozze(Record recordDettaglio) {
		return buildProtocollazioneDetailBozze(recordDettaglio, null);
	}
	
	public static ProtocollazioneDetailBozze buildProtocollazioneDetailBozze(Record recordDettaglio, Map<String, Object> params) {
		return buildProtocollazioneDetailBozze(recordDettaglio, params, null);
	}
	...
	public static boolean isAttivoProtocolloWizard(Record recordDettaglio) {
		if(recordDettaglio == null || (recordDettaglio.getAttribute("idUd") == null || "".equals(recordDettaglio.getAttribute("idUd"))) || 
		  (recordDettaglio.getAttribute("supportoOriginale") != null && !"".equals(recordDettaglio.getAttribute("supportoOriginale")))) {
	...
	public static boolean isClienteComuneMilano() {
		return AurigaLayout.getParametroDB("CLIENTE") != null && AurigaLayout.getParametroDB("CLIENTE").equalsIgnoreCase("CMMI");
	}
