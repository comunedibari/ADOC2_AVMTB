...
public class SelezionaEsitoTaskWindow extends Window {
	...
	public SelezionaEsitoTaskWindow(final Record attr, boolean flgMessaggio, final ServiceCallback<Record> callback){
		this(attr, flgMessaggio, null, null, callback);
	}
	...
	public SelezionaEsitoTaskWindow(final Record attr, final boolean flgMessaggio, Set<String> esitiTaskOk, final ServiceCallback<Record> callback){
		this(attr, flgMessaggio, esitiTaskOk, null, callback);
	}
		...
		confermaButton.addClickHandler(new com.smartgwt.client.widgets.events.ClickHandler() {			
			...
			public void onClick(com.smartgwt.client.widgets.events.ClickEvent event) {
				if(vm.validate()) {
					...
					String esito = esitoRecord.getAttribute(attr.getAttribute("nome"));
//					if(flgMessaggio && !isEsitoTaskOk(esito) && (esitoRecord.getAttribute("messaggio") == null || "".equals(esitoRecord.getAttribute("messaggio").trim()))) {
//						messaggioForm.setFieldErrors("messaggio", "E' obbligatorio specificare nel messaggio le motivazioni dell’esito selezionato");
//					} else {						
