...
//		tipoProcedimentoField = new ListGridField("tipoProcedimento",I18NUtil.getMessages().visure_in_iter_list_tipoProcedimentoField());   
//		tipoProcedimentoField.setWidth(100);
//		tipoProcedimentoField.setHidden(true);		
		
//		oggettoProcedimentoField = new ListGridField("oggettoProcedimento",I18NUtil.getMessages().visure_in_iter_list_oggettoProcedimentoField());
...
//		});	
		...
		//attoParereFinaleProcedimentoField = new ListGridField("attoParereFinaleProcedimento", I18NUtil.getMessages().visure_in_iter_list_attoParereFinaleProcedimentoField());
		...
		//nominativiProcedimentoField = new ListGridField("nominativiProcedimento",I18NUtil.getMessages().visure_in_iter_list_nominativiProcedimentoField());
		//nominativiProcedimentoField.setWidth(100);
		//nominativiProcedimentoField.setHidden(true);
		
		//assegnatarioProcedimentoField = new ListGridField("assegnatarioProcedimento",I18NUtil.getMessages().visure_in_iter_list_assegnatarioProcedimentoField());	
		...
		//avviatoDaField = new ListGridField("avviatoDa",I18NUtil.getMessages().visure_in_iter_list_avviatoDaField());
		...
		tipoRichiedente.setHeaderBaseStyle(it.eng.utility.Styles.hiddenHeaderButton);
	...
	protected void previewIstanza(final Record record) {
		...
		if (info != null && info.getMimetype() != null && info.getMimetype().equals("application/xml")) {
			...
			GWTRestService<Object, Object> lGwtRestService = new GWTRestService<Object, Object>("VisualizzaFatturaDataSource");
	...
	private Record getInfoFileRecord(final Record record) {
		...
		infoRecord.setAttribute("tipoFirma", record.getAttributeAsString("nome") != null && record.getAttributeAsString("nome").contains(".p7m") ? "CAdES" : "");
