...
public class SottomenuTaskDetail extends CustomDetail {
	...
	protected void buildListaTaskPratica(RecordList listaTask, VLayout lVLayout) {
		...
		for(int i = 0; i<listaTask.getLength();i++)
		{
			...
			Label taskLabel = new TaskLabel(displayName, dettagli, (isEseguibile ? null : recordTask.getAttribute("motiviNonEseg")), icona, flgFatta, flgEsito, flgDatiVisibili, dettaglioPraticaLayout);
