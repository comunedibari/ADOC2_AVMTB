...
public abstract class FirmaMultiplaHashHybridWindow extends HybridWindow {
	...
	public FirmaMultiplaHashHybridWindow(String appletTipoFirmaAtti, Map<String, Record> files) {
		this(appletTipoFirmaAtti, files, false);
	}

	public FirmaMultiplaHashHybridWindow(String appletTipoFirmaAtti, Map<String, Record> files, boolean pSkipCtrlBustaFirm) {
		...
		mAppletEng = new HybridEng("SignerAppletMulti", "SignerAppletMulti.jnlp", lMapParams, 357, 550, true, true, this,
			...
			public void realCloseClick(HybridWindow pWindow) {
				...
				if (uploadDone) {
					...
					GWTRestService<Object, Object> lGwtRestService = new GWTRestService<Object, Object>("AppletMultiplaDatasource");
					loadWindow.setZIndex(getZIndex());
					loadWindow.show("Trasferimento file in corso");
