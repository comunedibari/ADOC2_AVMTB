...
public class RegDaAnnullareCanvas extends ReplicableCanvas{
	...
	public void disegna() {
		...
		nroRegItem = new NumericItem("nroReg", "Prot N°");
		
		ImgButtonItem dettaglioUdRegButton = new ImgButtonItem("dettaglioUdRegButton", "buttons/detail.png", "Visualizza dettaglio registrazione");
		...
		dettaglioUdRegButton.addIconClickHandler(new IconClickHandler() {
			...
			public void onIconClick(IconClickEvent event) {
				...
				DettaglioRegProtAssociatoWindow dettaglioProtWindow = new DettaglioRegProtAssociatoWindow(lRecord, "Dettaglio prot. N° " + mDynamicForm.getValueAsString("nroReg"));
			}
		});
		...
		tsRichAnnItem = new DateTimeItem("tsRichAnn", "Ann. richiesto il");		
		
		uteRichAnnItem = new TextItem("uteRichAnn", "da");
		uteRichAnnItem.setWidth(150);
		
		motiviAnnItem = new TextItem("motiviAnn", "Motivi");
		motiviAnnItem.setWidth(250);
