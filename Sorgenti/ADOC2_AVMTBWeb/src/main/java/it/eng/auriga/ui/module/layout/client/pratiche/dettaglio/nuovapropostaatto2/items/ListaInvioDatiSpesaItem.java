...
public abstract class ListaInvioDatiSpesaItem extends GridItem {
	...
	protected ListGridField unitaOrgCdR;
	...
	protected ListGridField codFiscalePIVASogg;
	...
	public ListaInvioDatiSpesaItem(String name) {
		...
		unitaOrgCdR = new ListGridField("unitaOrgCdR", I18NUtil.getMessages().nuovaPropostaAtto2_detail_listaDatiContabili_unitaOrgCdR_title());
		...
		codFiscalePIVASogg = new ListGridField("codFiscalePIVASogg", I18NUtil.getMessages().nuovaPropostaAtto2_detail_listaDatiContabili_codFiscalePIVASogg_title());
...
//		grid.setStyleName(it.eng.utility.Styles.noBorderItem);
	...
	public void setGridFields(ListGridField... fields) {
		...
		ListaBean configLista = Layout.getListConfig("listaInvioDatiSpesa");
	...
	public void onClickNewButton() {
		InvioDatiSpesaWindow lInvioDatiSpesaWindow = new InvioDatiSpesaWindow("invioDatiSpesaWindow", null, true) {
	...
	public void onClickDetailButton(final ListGridRecord record) {
		final InvioDatiSpesaWindow lInvioDatiSpesaWindow = new InvioDatiSpesaWindow("invioDatiSpesaWindow", record, false);
		lInvioDatiSpesaWindow.show();
	}
	
	public void onClickModifyButton(final ListGridRecord record) {
		final InvioDatiSpesaWindow lInvioDatiSpesaWindow = new InvioDatiSpesaWindow("invioDatiSpesaWindow", record, true) {
			
			@Override
			public void saveData(Record newRecord) {
				updateData(newRecord, record);				
			}		
		};
		lInvioDatiSpesaWindow.show();
	}
