...
public abstract class SaveModelloWindow extends ModalWindow {
	...
	// private SelectItem idUoSelectItem;
	// private CheckboxItem flgVisibSottoUoCheckboxItem;
	// private CheckboxItem flgGestSottoUoCheckboxItem;

	DetailSection detailSectionSceltaUO;
	DetailSection detailSectionModello;
	...
	public void createSaveModelloForms() {
		...
		nomeComboBoxItem.setItemHoverFormatter(new FormItemHoverFormatter() {

			@Override
			public String getHoverHTML(FormItem item, DynamicForm form) {

				return (String) nomeComboBoxItem.getValue();
			}
		});
		...
		// form2.setHeight100();
		// form2.setNumCols(15);
		// form2.setColWidths(150, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, "*", "*");
		// form2.setCellPadding(5);
		// form2.setCanSubmit(true);
		// form2.setAlign(Alignment.CENTER);
		// form2.setTop(50);
		//
		// idUoSelectItem = new SelectItem("idUo", "Valido per UO");
		// idUoSelectItem.setStartRow(true);
		// idUoSelectItem.setWidth(300);
		// idUoSelectItem.setAlign(Alignment.CENTER);
		// idUoSelectItem.setWrapTitle(false);
		// idUoSelectItem.setDisplayField("descrizione");
		// idUoSelectItem.setValueField("idUo");
		// idUoSelectItem.setAllowEmptyValue(true);
		// idUoSelectItem.setValueMap(AurigaLayout.getUoProtocollantiValueMap());
		// if (AurigaLayout.getUoProtocollantiValueMap().size() == 1) {
		// idUoSelectItem.setValue(AurigaLayout.getUoProtocollantiValueMap().keySet().toArray(new String[1])[0]);
		// }
		// idUoSelectItem.setShowIfCondition(new FormItemIfFunction() {
		//
		// @Override
		// public boolean execute(FormItem item, Object value, DynamicForm form) {
		//
		// return isFlgPubblicoNotChecked();
		// }
		// });
		// idUoSelectItem.addChangedHandler(new ChangedHandler() {
		//
		// @Override
		// public void onChanged(ChangedEvent event) {
		//
		...
		// });
		//
		// flgVisibSottoUoCheckboxItem = new CheckboxItem("flgVisibSottoUo");
		// flgVisibSottoUoCheckboxItem.setTitle("visibile sotto-UO");
		// flgVisibSottoUoCheckboxItem.setShowTitle(false);
		// flgVisibSottoUoCheckboxItem.setWidth("*");
		// flgVisibSottoUoCheckboxItem.setAlign(Alignment.CENTER);
		// flgVisibSottoUoCheckboxItem.setShowIfCondition(new FormItemIfFunction() {
		//
		// @Override
		// public boolean execute(FormItem item, Object value, DynamicForm form) {
		//
		// return isFlgPubblicoNotChecked() && isIdUoSetted();
		// }
		// });
		//
		// flgGestSottoUoCheckboxItem = new CheckboxItem("flgGestSottoUo");
		// flgGestSottoUoCheckboxItem.setTitle("modificabile sotto-UO");
		// flgGestSottoUoCheckboxItem.setShowTitle(false);
		// flgGestSottoUoCheckboxItem.setWidth("*");
		// flgGestSottoUoCheckboxItem.setAlign(Alignment.CENTER);
		// flgGestSottoUoCheckboxItem.setShowIfCondition(new FormItemIfFunction() {
		//
		// @Override
		// public boolean execute(FormItem item, Object value, DynamicForm form) {
		//
		...
		// });
		//
		// form2.setFields(new FormItem[] { idUoSelectItem, flgVisibSottoUoCheckboxItem, flgGestSottoUoCheckboxItem });
	...
	// public boolean isIdUoSetted() {
	// return vm.getValue("idUoSvUt") != null && !"".equals(vm.getValueAsString("idUoSvUt"));
	// }
		...
		if(record != null){
			...
			if (userid != null && !"".equals(userid)) {
				if (userid.startsWith("PUBLIC.") && isAbilToSavePublic()) {
					...
					// String denominazioneUo = (String) record.getAttribute("denominazioneUo");
