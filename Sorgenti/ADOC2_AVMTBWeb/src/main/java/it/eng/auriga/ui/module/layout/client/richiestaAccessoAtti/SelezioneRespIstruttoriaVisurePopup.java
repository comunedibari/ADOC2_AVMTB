...
public abstract class SelezioneRespIstruttoriaVisurePopup extends ModalWindow {
	
	protected SelezioneRespIstruttoriaVisurePopup _window;
	...
	public SelezioneRespIstruttoriaVisurePopup(Record pListRecord){
		
		super("selezione_resp_istruttoria_visure", true);
		
		_window = this;
		
		setTitle("Seleziona responsabile istruttoria");
		...
		listaRespIstruttoriaItem.setAttribute("obbligatorio", true);
		
		_form.setItems(listaRespIstruttoriaItem);
		...
		confermaButton.addClickHandler(new com.smartgwt.client.widgets.events.ClickHandler() {	
			...
			public void onClick(com.smartgwt.client.widgets.events.ClickEvent event) {
				if(listaRespIstruttoriaItem.validate()) {
