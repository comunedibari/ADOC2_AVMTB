...
public class PostaInUscitaRegistrazioneList extends CustomList {
	...
	private ListGridField tipoCasellaMittenteField;
	private ListGridField statoConsolidamentoField;
	private ListGridField dataInvioField;
	...
	public PostaInUscitaRegistrazioneList(String nomeEntita) {
		...
		idEmailField = new ListGridField("idEmail", I18NUtil.getMessages().postainuscitaregistrazione_list_idEmailField_title());
		idEmailField.setHidden(true);	
		
		// Tipo di casella ( C=casella PEC, O=casella PEO, null) 
		tipoCasellaMittenteField = new ListGridField("tipoCasellaMittente",   I18NUtil.getMessages().postainuscitaregistrazione_list_tipoCasellaMittenteField_title());
		tipoCasellaMittenteField.setType(ListGridFieldType.ICON);
		tipoCasellaMittenteField.setHeaderBaseStyle(it.eng.utility.Styles.hiddenHeaderButton);
		tipoCasellaMittenteField.setAlign(Alignment.CENTER);
		tipoCasellaMittenteField.setWidth(30);
		tipoCasellaMittenteField.setIconWidth(16);
		tipoCasellaMittenteField.setIconHeight(16);
		Map<String, String> tipoCasellaMittenteValueIcons = new HashMap<String, String>();		
		tipoCasellaMittenteValueIcons.put("C", "anagrafiche/rubrica_email/PEC.png");
		tipoCasellaMittenteValueIcons.put("O", "anagrafiche/rubrica_email/PEO.png");
		tipoCasellaMittenteValueIcons.put("",  "blank.png");
		tipoCasellaMittenteField.setValueIcons(tipoCasellaMittenteValueIcons);		
		tipoCasellaMittenteField.setHoverCustomizer(new HoverCustomizer() {			
			@Override
			public String hoverHTML(Object value, ListGridRecord record, int rowNum, int colNum) {
				
				if("C".equals(record.getAttribute("tipoCasellaMittente"))) {
					return I18NUtil.getMessages().postainuscitaregistrazione_tipoCasellaMittente_C_Alt_value();
				}	
				else if("O".equals(record.getAttribute("tipoCasellaMittente"))) {
					return I18NUtil.getMessages().postainuscitaregistrazione_tipoCasellaMittente_O_Alt_value();
				}
				else
				   return null;
			}
		...
		dataInvioField = new ListGridField("dataInvio", I18NUtil.getMessages().postainuscitaregistrazione_list_dataInvioField_title());
		dataInvioField.setType(ListGridFieldType.DATE);
		dataInvioField.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATETIME);
		
		destinatariField = new ListGridField("destinatari", I18NUtil.getMessages().postainuscitaregistrazione_list_destinatariField_title());
		destinatariField.setAlign(Alignment.LEFT);
