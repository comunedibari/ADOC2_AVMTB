	...
	public TitolarioDetail(String nomeEntita) {
		...
		periodoConservInItem.setShowIfCondition(new FormItemIfFunction() {
			...
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				...
				Boolean flgConservIllimitata = (Boolean) form.getValue("flgConservPermIn");
		...
		form.setFields(idPianoClassifItem, idClassificazioneItem, idClassificaSupItem, flgStoricizzaDatiItem, descrizioneItem, paroleChiaveItem,
				tsValidaDalItem, tsValidaFinoAlItem, spacerItem, flgConservPermInItem, periodoConservInItem, flgNoRichAbilItem);
