	...
	public AttivaDelegaBean call(AttivaDelegaBean bean) throws Exception {
		...
		if (lDmpkLoginStartsessioneindelegaOutput.isInError()) {
			if (StringUtils.isNotBlank(lDmpkLoginStartsessioneindelegaOutput.getResultBean().getWarningmsgout())) {
				...
				throw new StoreException(lDmpkLoginStartsessioneindelegaOutput.getDefaultMessage());
			}
		}
		lAurigaLoginBean.setDelegaDenominazione(lDmpkLoginStartsessioneindelegaOutput.getResultBean().getDesuserdeleganteout());
		...
		if (lDmpkLoginGetuserprivsOutput.isInError()) {
			throw new StoreException(lDmpkLoginGetuserprivsOutput.getDefaultMessage());
		}
		...
		if (lDmpkIntMgoEmailGetidutentemgoemailOutput.isInError()) {
			throw new StoreException(lDmpkIntMgoEmailGetidutentemgoemailOutput.getDefaultMessage());
		}
