...
public class TimbraDatasource extends AbstractServiceDataSource<OpzioniTimbroBean, TimbraResultBean> {
	...
	public TimbraResultBean call(OpzioniTimbroBean bean) throws Exception 
	{
		...
		TimbraResultBean lTimbraResultBean = timbraUtility.timbra(bean, getSession());
	...
	public OpzioniTimbroBean getSegnatura(OpzioniTimbroBean bean) throws Exception {
		...
		lOpzioniTimbroBean.setPosizioneIntestazione(lOpzioniTimbroAttachEmail.getPosizioneIntestazione() != null ? lOpzioniTimbroAttachEmail
				.getPosizioneIntestazione().value() : null);
		lOpzioniTimbroBean.setPosizioneTestoInChiaro(lOpzioniTimbroAttachEmail.getPosizioneTestoInChiaro() != null ? lOpzioniTimbroAttachEmail
				.getPosizioneTestoInChiaro().value() : null);
