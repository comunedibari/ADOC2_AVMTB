...
public class ProcedimentiPersonaliDatasource extends AbstractFetchDataSource<ProcedimentiPersonaliBean> {
...
//			lProcedimentiPersonaliBean.setOggettoProcedimento(HtmlUtils.htmlEscape(lProcedimentiPersonaliBean.getOggettoProcedimento()));
		...
		return new PaginatorBean<ProcedimentiPersonaliBean>(lList);
	}
