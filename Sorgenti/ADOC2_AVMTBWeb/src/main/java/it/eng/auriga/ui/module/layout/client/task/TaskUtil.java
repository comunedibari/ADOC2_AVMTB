		...
		lAurigaTaskDataSource.call(lCallExecAttRecord, new ServiceCallback<Record>() {
			...
			public void execute(final Record record) {
				...
				if (record.getAttribute("warningMsg") != null && !"".equals(record.getAttribute("warningMsg"))) {
					...
					Button procediButton = Dialog.OK;
					procediButton.setTitle("Procedi");
					Button annullaButton = Dialog.CANCEL;
					annullaButton.setTitle("Annulla");
					dialogProperties.setButtons(procediButton, annullaButton);
					dialogProperties.setIcon("warning.png");
					SC.ask("Attenzione!", record.getAttribute("warningMsg"), new BooleanCallback() {
						...
						public void execute(Boolean value) {
							...
							if (value != null && value) {
								if (idGUIEvento != null && (idGUIEvento.equals("MSG_ATTIV") || idGUIEvento.equals("SCELTA_ESITO"))) {
									...
									GWTRestService<Object, Object> lAttributiDinamiciDatasource = new GWTRestService<Object, Object>(
