...
public class CKEditorItem extends CanvasItem implements IEditorItem, IDatiSensibiliItem {
	...
	public CKEditorItem(String name) {
		super(name);
		ckeCanvas = new CKEditor(SC.generateID());
	...
	public String getValue() {
		if(ckeCanvas.isInitialized()) {
			String value = getCKEditorValue(ckeCanvas.getID()+"_ta");
	...
	public void setCanEdit(Boolean canEdit) {
		if(ckeCanvas.isInitialized()) {
			if (isCKEditorReady(ckeCanvas.getID()+"_ta")) {
				setCKEditorReadOnly(ckeCanvas.getID()+"_ta", !canEdit);
			} else {
				setCKEditorReadOnlyOnStartup(ckeCanvas.getID()+"_ta", !canEdit);
			}
		}
	}
