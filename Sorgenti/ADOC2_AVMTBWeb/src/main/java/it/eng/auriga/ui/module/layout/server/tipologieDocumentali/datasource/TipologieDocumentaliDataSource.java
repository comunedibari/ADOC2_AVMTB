...
public class TipologieDocumentaliDataSource extends AbstractFetchDataSource<TipologieDocumentaliBean> {
	...
	@Override
	public PaginatorBean<TipologieDocumentaliBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby)
			throws Exception {
	
		log.info("start search tipo doc");
	...
	public TipologieDocumentaliBean get(TipologieDocumentaliBean bean) throws Exception {
		...
		log.info("start get tipologia documentale");
		...
		result.setIdDocTypeGen(output.getResultBean().getIddoctypegenout() != null && !"".equals(output.getResultBean().getIddoctypegenout()) ? output
				.getResultBean().getIddoctypegenout().toString() : null);
		...
		result.setPeriodoConservAnni(output.getResultBean().getPeriodoconservout() != null && output.getResultBean().getPeriodoconservout().intValue() != 0 ? output
				.getResultBean().getPeriodoconservout().intValue()
				: null);

		result.setFlgRichAbilVis(output.getResultBean().getFlgrichabilxvisualizzout() != null && output.getResultBean().getFlgrichabilxvisualizzout() == 1 ? true
				: false);
		result.setFlgRichAbilXGestIn(output.getResultBean().getFlgrichabilxgestout() != null && output.getResultBean().getFlgrichabilxgestout() == 1 ? true
				: false);
		result.setFlgRichAbilXAssegnIn(output.getResultBean().getFlgrichabilxassegnout() != null && output.getResultBean().getFlgrichabilxassegnout() == 1 ? true
				: false);
	...
	public TipologieDocumentaliBean add(TipologieDocumentaliBean bean) throws Exception {
		...
		log.info("start save tipologia documentale");
		...
		log.info("end save tipologia documentale");
		return bean;
	}
	...
	public TipologieDocumentaliBean update(TipologieDocumentaliBean bean, TipologieDocumentaliBean oldvalue) throws Exception {
		...
		log.info("start update tipologia documentale");
		...
		log.info("end update tipologia documentale");
	...
	public TipologieDocumentaliBean remove(TipologieDocumentaliBean bean) throws Exception {
		...
		log.info("start remove tipologia documentale");
	 ...
	 */
	protected String getXMLAttrAddXEvtDelTipoInOutBean(TipologieDocumentaliBean bean) throws JAXBException, IllegalAccessException, InvocationTargetException,
