...
public class AurigaConfigurationBean {
	...
	/**
	 * @param parametriDB the parametriDB to set
	 */
	...
	/**
	 * @param nomiModelliAtti the nomiModelliAtti to set
	 */
	...
	/**
	 * @param hiddenFieldsAtti the hiddenFieldsAtti to set
	 */
	...
	/**
	 * @param utentiAbilCPAList the utentiAbilCPAList to set
	 */
