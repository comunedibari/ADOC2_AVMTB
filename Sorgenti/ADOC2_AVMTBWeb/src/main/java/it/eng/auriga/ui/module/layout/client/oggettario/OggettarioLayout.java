...
public class OggettarioLayout extends CustomLayout {
	...
	public static boolean isRecordAbilToMod(boolean flgCreatoDaMe, boolean flgDiSistema) {
		return !flgDiSistema && (Layout.isPrivilegioAttivo("UT/MO/PB;M") || (flgCreatoDaMe && Layout.isPrivilegioAttivo("UT/MO/PR;M")));
	}

	public static boolean isRecordAbilToDel(boolean flgCreatoDaMe, boolean flgDiSistema) {
		return !flgDiSistema && (Layout.isPrivilegioAttivo("UT/MO/PB;FC") || (flgCreatoDaMe && Layout.isPrivilegioAttivo("UT/MO/PR;FC")));
	}
	...
	public void viewMode() {
		...
		if(isRecordAbilToDel(flgCreatoDaMe, flgDiSistema)){
			deleteButton.show();
		} else {
			deleteButton.hide();
		}	
		if(isRecordAbilToMod(flgCreatoDaMe, flgDiSistema)) {
			editButton.show();
		} else{
			editButton.hide();
		}	
