...
public class AnagrafeProcedimentiLayout extends CustomLayout {
	...
	public AnagrafeProcedimentiLayout(String finalita, Boolean showOnlyDetail) {
		super("anagrafe_procedimenti", new GWTRestDataSource("AnagrafeProcedimentiDataSource", "id", FieldType.TEXT), new ConfigurableFilter(
				"anagrafe_procedimenti"), new AnagrafeProcedimentiList("anagrafe_procedimenti"), new AnagrafeProcedimentiDetail("anagrafe_procedimenti"),
