...
public class DirigenteAdottanteCanvas extends ReplicableCanvas {
	...
	protected SelectItemWithDisplay dirigenteAdottanteItem;
	...
	public void disegna() {
		...
		SelectGWTRestDataSource dirigenteAdottanteDS = new SelectGWTRestDataSource("LoadComboDirigenteAdottanteDataSource", "idSv", FieldType.TEXT, new String[]{"codUo", "descrizione"}, false);
		
		dirigenteAdottanteItem = new SelectItemWithDisplay("dirigenteAdottante", I18NUtil.getMessages().nuovaPropostaAtto2_detail_dirigenteAdottante_title(), dirigenteAdottanteDS) {
			...
			public void onOptionClick(Record record) {
				...
				codUoDirigenteAdottanteHiddenItem.setValue(record.getAttributeAsString("codUo"));			
				desDirigenteAdottanteHiddenItem.setValue(record.getAttributeAsString("descrizione"));			
			}

			@Override
			protected void clearSelect() {
				super.clearSelect();
				dirigenteAdottanteItem.clearValue();
				codUoDirigenteAdottanteHiddenItem.clearValue();		
				desDirigenteAdottanteHiddenItem.clearValue();		
			};
		...
		dirigenteAdottanteItem.setWidth(500);
		dirigenteAdottanteItem.setValueField("idSv");
		ListGridField codUoAdottanteField = new ListGridField("codUo", "Cod. U.O.");
		codUoAdottanteField.setWidth(80);		
		ListGridField descrizioneAdottanteField = new ListGridField("descrizione", "Descrizione");
		dirigenteAdottanteItem.setPickListFields(codUoAdottanteField, descrizioneAdottanteField);						
		...
		flgAdottanteAncheRdPItem = new CheckboxItem("flgAdottanteAncheRdP", I18NUtil.getMessages().nuovaPropostaAtto2_detail_flgAdottanteAncheRdP_title());
		...
		flgAdottanteAncheRUPItem = new CheckboxItem("flgAdottanteAncheRUP", I18NUtil.getMessages().nuovaPropostaAtto2_detail_flgAdottanteAncheRUP_title());
	...
	public void resetAfterChangedIdUoProponente() {
		dirigenteAdottanteItem.clearValue();
		codUoDirigenteAdottanteHiddenItem.clearValue();
		desDirigenteAdottanteHiddenItem.clearValue();
		dirigenteAdottanteItem.fetchData();
	}
