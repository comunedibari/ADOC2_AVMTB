...
public class DettaglioProfiloDetail extends CustomDetail{
	...
	public void visualizzaListaFunzioni(String idProfilo, String nomeProfilo) {
		ListaFunzionalitaWindow funzionalitaPopup = new ListaFunzionalitaWindow("Abilitazioni a funzioni per il profilo", idProfilo, nomeProfilo, true, Layout.isPrivilegioAttivo("SIC/PR;M"));		
