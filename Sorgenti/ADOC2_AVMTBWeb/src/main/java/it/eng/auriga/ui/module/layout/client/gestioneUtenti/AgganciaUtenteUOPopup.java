...
public abstract class AgganciaUtenteUOPopup extends ModalWindow {
	...
	private void disegnaForm() {
		...
		tipoDiAssegnazioneSelectItem.setWidth(587);
		...
		flgInclSottoUoItem.setValue((boolean) false);
		...
		flgInclScrivVirtItem.setValue((boolean) false);
		...
		denominazioneScrivaniaUtenteItem.setWidth(587);
