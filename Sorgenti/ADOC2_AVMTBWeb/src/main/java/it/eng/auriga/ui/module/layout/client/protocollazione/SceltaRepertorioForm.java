...
public class SceltaRepertorioForm extends DynamicForm {
	...
	public SceltaRepertorioForm(final String repertorioDefault, final SceltaRepertorioPopup pWindow, final ServiceCallback<Record> callback) {
		...
		gruppiRepertorioDS.addParam("flgTipoProv", "I");
