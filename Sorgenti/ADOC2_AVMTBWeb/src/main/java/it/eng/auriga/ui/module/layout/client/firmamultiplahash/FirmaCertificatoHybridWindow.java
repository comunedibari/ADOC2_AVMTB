...
public abstract class FirmaCertificatoHybridWindow extends HybridWindow {
	...
	public FirmaCertificatoHybridWindow(Map<String, Record> files, String pin, String firmatario, String alias, String metodoFirma) {
		this(null, files, false, pin, firmatario, alias, metodoFirma);
	}

	public FirmaCertificatoHybridWindow(String appletTipoFirmaAtti, Map<String, Record> files, boolean pSkipCtrlBustaFirm, String pin, String firmatario,
