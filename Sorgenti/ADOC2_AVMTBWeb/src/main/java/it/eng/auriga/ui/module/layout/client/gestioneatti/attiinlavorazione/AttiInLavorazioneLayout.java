 ...
 *
 */
public class AttiInLavorazioneLayout extends CustomLayout {
	...
	public AttiInLavorazioneLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola, Boolean showOnlyDetail) {
		super(nomeEntita, new GWTRestDataSource("AttiInLavorazioneDatasource"), createFilter(nomeEntita), new AttiInLavorazioneList(nomeEntita),
