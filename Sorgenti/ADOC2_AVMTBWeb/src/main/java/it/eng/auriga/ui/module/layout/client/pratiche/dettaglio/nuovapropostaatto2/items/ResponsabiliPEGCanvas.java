...
public class ResponsabiliPEGCanvas extends ReplicableCanvas {
	...
	private SelectItemWithDisplay responsabilePEGItem;
	...
	public void disegna() {
		...
		SelectGWTRestDataSource responsabilePEGDS = new SelectGWTRestDataSource("LoadComboResponsabiliPEGDataSource", "idSv", FieldType.TEXT, true, new String[]{"codUo", "descrizione"}, false);
		
		responsabilePEGItem = new SelectItemWithDisplay("responsabilePEG", responsabilePEGDS) {
		...
		responsabilePEGItem.setWidth(500);
		...
		mDynamicForm.setFields(responsabilePEGItem, codUoResponsabilePEGHiddenItem, desResponsabilePEGHiddenItem);	
