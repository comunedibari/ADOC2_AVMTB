...
public class HsmClientFactory {
	...
	protected static HsmConfig getArubaHsmConfig(HttpSession session, FirmaHsmBean firmaHsmBean)
		...
		String xmlParametriHsm = ParametriDBUtil.getParametroDB(session, "HSM_PARAMETERS");
	...
	protected static HsmConfig getInfoCertHsmConfig(HttpSession session, FirmaHsmBean firmaHsmBean) {
		return null;
	}
