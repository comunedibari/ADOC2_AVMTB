...
public class LogLoginTryCallHelper {
	...
	public final boolean call(AurigaLoginBean aurigaLoginBean, String codApplicazione, String username, boolean flagKO, String codIdConnectionToken,
			String parametriClient) throws Exception {
		...
		param.setFlgtpdominioautin(null);
		param.setIddominioautin(null);
	...
	public final boolean call(String schema, String codApplicazione, String username, boolean flagKO, String codIdConnectionToken, String parametriClient)
			throws Exception {
		final AurigaLoginBean aurigaLoginBean = new AurigaLoginBean();
		aurigaLoginBean.setCodApplicazione(codApplicazione);
		aurigaLoginBean.setLinguaApplicazione(locale.getLanguage());
		aurigaLoginBean.setSchema(schema);
		return call(aurigaLoginBean, codApplicazione, username, flagKO, codIdConnectionToken, parametriClient);
	}
