...
public class EnhancedLoginModuleImpl extends LoginModuleImpl {
	...
	public boolean abort() throws LoginException {
		...
		try {
			...
			parametriClient = ParametriClientExtractor.getJsonParametriClient(ClientDataThreadLocal.get());
			if ("null".equalsIgnoreCase(parametriClient)) {
		...
		try {
			...
			logLoginTryHelperCall.call(schema, null, username, true, null, parametriClient);
		} catch (Exception e) {
