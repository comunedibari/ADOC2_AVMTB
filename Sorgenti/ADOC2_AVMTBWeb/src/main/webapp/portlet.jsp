...
- QuÃ©bec Free and Open-Source Licence - Reciprocity (LiLiQ-R) or Strong
  Reciprocity (LiLiQ-R+).
...
<script src="script/pdfViewer/build/pdf.worker.js"></script>
<script src="script/pdfViewer/build/pdf.js"></script>
<script src="script/pdfViewer/web/viewer.js"></script>
...
<body id="body">
	...
	<script type="text/javascript" language="javascript"
		src="layout/layout.nocache.js"></script>
	...
	<%String nomeEntita = request.getParameter("nomeEntita") != null ? request.getParameter("nomeEntita") : "";
			String schema = request.getParameter("schema") != null ? (String) request.getParameter("schema") : "";
			String useridappl = request.getParameter("userid") != null ? (String) request.getParameter("userid") : "";
			String password = request.getParameter("password") != null ? (String) request.getParameter("password") : "";
			String listaFatture = request.getParameter("listaFatture") != null
					? request.getParameter("listaFatture")
					: "";
			String callbackUrl = request.getParameter("callbackUrl") != null ? request.getParameter("callbackUrl") : "";
			String closeCallbackUrl = request.getParameter("closeCallbackUrl") != null
					? request.getParameter("closeCallbackUrl")
					: "";
	...
	*/
	function doSelectCertificate(lMapParams) {
		/*
			...
			callback è il metodo definito all'interno di processHttpRequest
		*/
