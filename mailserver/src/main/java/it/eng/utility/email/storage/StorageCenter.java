...
public class StorageCenter {
	...
	private static final String PROGRAM_PREFIX = "MailConnect.";

	/**
	 * Restituisce lo storage di base da utilizzare per ogni singola mailBox. Il nome dell'utilizzatore è ottenuto concatenando "MailConnect." all'id della
	 * mailBox
	 * 
	 * @param idMailBox
	...
	/**
	 * Restituisce lo storage da utilizzare per la data operazione di ogni singola mailBox. Il nome dell'utilizzatore è ottenuto concatenando PROGRAM_PREFIX
	 * l'id della mailBox, ".", nome dell'operazione
	 * 
	 * @param idMailBox
	 *            L'id che individua ogni singola mailBox
	 * @param operationName
	 *            Il nome dell'operazione (come ricavato da
	 * @return
	 */
