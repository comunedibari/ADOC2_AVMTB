...
declare
  ...
  my_mailbox_account varchar2(150) := 'ateneo@pec.unina.it';
  ...
  my_mailbox_name varchar2(20) := 'ATENEO'; 
  ...
  my_string_db_connection varchar2(200) := 'jdbc:oracle:thin:ente01/ente01@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=143.225.212.26)(PORT=1521))(CONNECT_DATA=(SERVER=dedicated)(SERVICE_NAME=PROT)))';
