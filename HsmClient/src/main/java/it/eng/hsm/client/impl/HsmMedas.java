...
public class HsmMedas extends HsmImpl {
	...
	public SignResponseBean firmaCades(byte[] bytesFileDaFirmare, SignOption signOption)
		...
		try {
			...
			String fileDaFirmare = Base64.encodeBase64String(bytesFileDaFirmare);
			...
			if (messageCode != null && !messageCode.equals(new BigInteger("0"))) {
				...
				signResponseBean.getFileResponseBean().setMessageBean(messageBean);
				signResponseBean.getFileResponseBean().setFileFirmato(Base64.decodeBase64(responseDoc.getBytes()));
			}
	...
	public SignResponseBean firmaCadesParallela(byte[] bytesFileDaFirmare, SignOption signOption)
		...
		try {
			...
			if (messageCode != null && !messageCode.equals(new BigInteger("0"))) {
				...
				messageBean.setStatus(ResponseStatus.OK);
				signResponseBean.getFileResponseBean().setMessageBean(messageBean);
				signResponseBean.getFileResponseBean().setFileFirmato(responseDoc.getBytes());
			}
