...
public class HsmItagile extends HsmImpl {
	...
	@Override
	public SignResponseBean firmaCades(byte[] bytesFileDaFirmare, SignOption signOption)
		...
		try {
			...
			byte[] fileOutput = itagileService.signCAdES(userCred, bytesFileDaFirmare, "SHA256", null, sigFlags);
	...
	@Override
	public SignResponseBean firmaCadesParallela(byte[] bytesFileDaFirmare, SignOption signOption)
			throws HsmClientConfigException, HsmClientSignatureException, UnsupportedOperationException {
	...
	@Override
	public SignResponseBean firmaPades(byte[] bytesFileDaFirmare, SignOption signOption)
			throws HsmClientConfigException, HsmClientSignatureException, UnsupportedOperationException {
		...
		try {
			...
			byte[] fileOutput = itagileService.signPDF(userCred, bytesFileDaFirmare, false, "SHA256", null, sigFlags, 
	...
	@Override
	public SignResponseBean firmaXades(byte[] bytesFileDaFirmare, SignOption signOption)
			throws HsmClientConfigException, HsmClientSignatureException, UnsupportedOperationException {
		...
		try {
			...
			byte[] fileOutput = itagileService.signXAdES(userCred, bytesFileDaFirmare, "SHA256", null, params);
	...
	public OtpResponseBean richiediOTP() throws HsmClientConfigException, UnsupportedOperationException {
		throw new UnsupportedOperationException("Funzionalita'� di richiesta codice OTP non supportata");
	}
