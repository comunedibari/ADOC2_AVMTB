...
public class LoaddettclassificaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"flgfolderizzaxannoout",18,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgrichabilxvisout",19,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgrichabilxgestout",20,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgrichabilxfirmaout",21,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgrichabilxassegnout",22,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgrichabilxaperfascout",23,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgclassifinibitaout",24,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"provciclassifout",25,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"xmltemplatexfascout",26,Types.CLOB); 
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"flgmostraaltriattrout",29,Types.INTEGER); 
