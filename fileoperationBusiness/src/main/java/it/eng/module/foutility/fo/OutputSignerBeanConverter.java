...
public class OutputSignerBeanConverter {
	...
	/**
	 * ritorna un oggetto validationinfo relativo ad una prop che � una mappa di validaioninfo associate alle varie firme: ad esempio la prop
	 * SIGNATURE_VALIDATION_PROPERTY contiene la mappa con le info di validit� per ogni firma, in tal caso il metodo ritorna un oggetto validationInfo che
