...
public class InputFileUtil {
	...
	public static File getTempFile(InputFile input,File tempDir,boolean launchErrorifNotFound, String sistemaOperativo, 
			String fileName, String requestKey)throws Exception{
		File file=null;
...
//				}
			...
			try {
				...
				IOUtils.copyLarge(dh.getInputStream(), lFileOutputStream);
