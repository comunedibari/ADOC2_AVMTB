...
public class GestioneFascicoli {
	...
	private BusinessType type = AurigaBusinessClientConfig.getInstance().getBusinesstype();  	
	 ...
	 //it.eng.document.function.bean.TrovaDocFolderOut 
  	 public it.eng.document.function.bean.TrovaDocFolderOut  trovadocfolderws(Locale locale,it.eng.auriga.module.business.beans.AurigaLoginBean var2,it.eng.auriga.function.bean.FindRepositoryObjectBean var3) throws Exception {
		mLogger.debug("URL vale " + url);
		mLogger.debug("BusinessType vale " + type.name());
  	  	Type   outputType =	new TypeToken<it.eng.document.function.bean.TrovaDocFolderOut>() {}.getType();
  	  	return (it.eng.document.function.bean.TrovaDocFolderOut)FactoryBusiness.getBusiness(type).call(url, locale,it.eng.document.function.bean.TrovaDocFolderOut.class,outputType, SERVICE_NAME, "trovaDocFolderWS", var2,var3);
	 } 
