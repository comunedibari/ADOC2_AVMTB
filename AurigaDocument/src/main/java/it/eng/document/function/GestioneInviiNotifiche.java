			...
			try {
				...
				if("I".equals(pModificaInvioNotificaBean.getFlgInvioNotifica())) {
					...
					if (result.isInError()){
						...
						final MarktokenusageImpl lMarktokenusageInvio = new MarktokenusageImpl();
						DmpkLoginMarktokenusageBean lMarktokenusageBeanInvio = new DmpkLoginMarktokenusageBean();
						if (pAurigaLoginBean.getToken()!=null)
							lMarktokenusageBeanInvio.setCodidconnectiontokenin(pAurigaLoginBean.getToken());
						lMarktokenusageBeanInvio.setFlgautocommitin(0);
						lMarktokenusageInvio.setBean(lMarktokenusageBeanInvio);
						session.doWork(new Work() {
							@Override
							public void execute(Connection paramConnection) throws SQLException {
								lMarktokenusageInvio.execute(paramConnection);
							}
						});						
					...
					if (result.isInError()){
						...
						final MarktokenusageImpl lMarktokenusageNotifica = new MarktokenusageImpl();
						DmpkLoginMarktokenusageBean lMarktokenusageBeanNotifica = new DmpkLoginMarktokenusageBean();
						if (pAurigaLoginBean.getToken()!=null)
							lMarktokenusageBeanNotifica.setCodidconnectiontokenin(pAurigaLoginBean.getToken());
						lMarktokenusageBeanNotifica.setFlgautocommitin(0);
						lMarktokenusageNotifica.setBean(lMarktokenusageBeanNotifica);
						session.doWork(new Work() {
							@Override
							public void execute(Connection paramConnection) throws SQLException {
								lMarktokenusageNotifica.execute(paramConnection);
							}
						});						
