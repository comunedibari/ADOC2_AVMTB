	...
	public CreaModFonteOutBean creaFonte(AurigaLoginBean pAurigaLoginBean, CreaModFonteInBean pCreaModFonteInBean,
		...
		try {
			...
			try {
				...
				StoreResultBean<DmpkLoginMarktokenusageBean> lMarktokenusageResult = new StoreResultBean<DmpkLoginMarktokenusageBean>();
				AnalyzeResult.analyze(lMarktokenusageBean, lMarktokenusageResult);
				lMarktokenusageResult.setResultBean(lMarktokenusageBean);

				if (lMarktokenusageResult.isInError()) {
					mLogger.error("Errore " + lMarktokenusageResult.getDefaultMessage());
					throw new StoreException(lMarktokenusageResult);
				} else {
