 ...
 * Schema.
 * $Id: Output_UD.java,v 1.1 2008/09/29 16:05:38 str Exp $
 */
 ...
 * Service di creazione e aggiornamento di unita' documentaria (non
 * l'esito del processo di creazione/aggiornamento dell'unita'
...
public class Output_UD implements java.io.Serializable {
    ...
    } //-- it.eng.auriga.addon.openoffice.core.outputud.Output_UD()
    ...
    } //-- void addRegistrazioneDataUD(it.eng.auriga.addon.openoffice.core.outputud.RegistrazioneDataUD) 
    ...
    } //-- void addRegistrazioneDataUD(int, it.eng.auriga.addon.openoffice.core.outputud.RegistrazioneDataUD) 
    ...
    } //-- void addVersioneElettronicaNonCaricata(it.eng.auriga.addon.openoffice.core.outputud.VersioneElettronicaNonCaricata) 
    ...
    } //-- void addVersioneElettronicaNonCaricata(int, it.eng.auriga.addon.openoffice.core.outputud.VersioneElettronicaNonCaricata) 
     ...
     * all'unita' documentaria nel sistema documentale
     * 
    ...
    } //-- it.eng.auriga.addon.openoffice.core.outputud.RegistrazioneDataUD getRegistrazioneDataUD(int) 
    ...
    public it.eng.auriga.repository2.jaxws.webservices.util.castor.outputud.RegistrazioneDataUD[] getRegistrazioneDataUD()
    {
        ...
        return array;
    } //-- it.eng.auriga.addon.openoffice.core.outputud.RegistrazioneDataUD[] getRegistrazioneDataUD() 
    ...
    } //-- it.eng.auriga.addon.openoffice.core.outputud.VersioneElettronicaNonCaricata getVersioneElettronicaNonCaricata(int) 
    ...
    public it.eng.auriga.repository2.jaxws.webservices.util.castor.outputud.VersioneElettronicaNonCaricata[] getVersioneElettronicaNonCaricata()
    {
        ...
        return array;
    } //-- it.eng.auriga.addon.openoffice.core.outputud.VersioneElettronicaNonCaricata[] getVersioneElettronicaNonCaricata() 
    ...
    public boolean removeRegistrazioneDataUD(it.eng.auriga.repository2.jaxws.webservices.util.castor.outputud.RegistrazioneDataUD vRegistrazioneDataUD)
    {
        ...
        return removed;
    } //-- boolean removeRegistrazioneDataUD(it.eng.auriga.addon.openoffice.core.outputud.RegistrazioneDataUD) 
    ...
    } //-- it.eng.auriga.addon.openoffice.core.outputud.RegistrazioneDataUD removeRegistrazioneDataUDAt(int) 
    ...
    public boolean removeVersioneElettronicaNonCaricata(it.eng.auriga.repository2.jaxws.webservices.util.castor.outputud.VersioneElettronicaNonCaricata vVersioneElettronicaNonCaricata)
    {
        ...
        return removed;
    } //-- boolean removeVersioneElettronicaNonCaricata(it.eng.auriga.addon.openoffice.core.outputud.VersioneElettronicaNonCaricata) 
    ...
    } //-- it.eng.auriga.addon.openoffice.core.outputud.VersioneElettronicaNonCaricata removeVersioneElettronicaNonCaricataAt(int) 
    ...
    } //-- void setRegistrazioneDataUD(int, it.eng.auriga.addon.openoffice.core.outputud.RegistrazioneDataUD) 
    ...
    } //-- void setRegistrazioneDataUD(it.eng.auriga.addon.openoffice.core.outputud.RegistrazioneDataUD) 
    ...
    } //-- void setVersioneElettronicaNonCaricata(int, it.eng.auriga.addon.openoffice.core.outputud.VersioneElettronicaNonCaricata) 
    ...
    } //-- void setVersioneElettronicaNonCaricata(it.eng.auriga.addon.openoffice.core.outputud.VersioneElettronicaNonCaricata) 
    ...
    } //-- it.eng.auriga.addon.openoffice.core.outputud.Output_UD unmarshal(java.io.Reader) 
